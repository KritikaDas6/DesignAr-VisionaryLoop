...
//spec_const bool sc_ProxyAlphaOne 121 0
//spec_const bool sc_RayTracedAoTextureHasSwappedViews 122 0
//spec_const bool sc_RayTracedDiffIndTextureHasSwappedViews 123 0
//spec_const bool sc_RayTracedReflectionTextureHasSwappedViews 124 0
//spec_const bool sc_RayTracedShadowTextureHasSwappedViews 125 0
...
//spec_const int sc_RayTracedAoTextureLayout 194 0
//spec_const int sc_RayTracedDiffIndTextureLayout 195 0
//spec_const int sc_RayTracedReflectionTextureLayout 196 0
//spec_const int sc_RayTracedShadowTextureLayout 197 0
//spec_const int sc_RenderingSpace 198 -1
//spec_const int sc_ScreenTextureLayout 199 0
//spec_const int sc_ShaderCacheConstant 200 0
//spec_const int sc_SkinBonesCount 201 0
//spec_const int sc_StereoRenderingMode 202 0
//spec_const int sc_StereoRendering_IsClipDistanceEnabled 203 0
//spec_const int sc_StereoViewID 204 0
//SG_REFLECTION_END
...
#endif
l9_269=N7_vec3srgbToLinear(l9_328)*reflectionIntensity;
}
#else
{
l9_269=vec3(0.0);
...
l9_379=vec3(0.0)+(N7_vec3srgbToLinear(l9_381)*ssPow(l9_435,rimExponent));
}
#else
{
l9_379=vec3(0.0);
...
float l9_458=l9_457;
vec3 l9_459=sc_SamplingCoordsViewToGlobal(vec2(l9_454,l9_456),materialParamsTexLayout,materialParamsTexGetStereoViewIndex());
vec4 l9_460=texture(materialParamsTexArrSC,l9_459,0.0);
vec4 l9_461;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_461=mix(materialParamsTexBorderColor,l9_460,vec4(l9_458));
}
#else
{
l9_461=l9_460;
...
#else
{
bool l9_462=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0));
float l9_463=l9_436.x;
sc_SoftwareWrapEarly(l9_463,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x);
float l9_464=l9_463;
float l9_465=l9_436.y;
sc_SoftwareWrapEarly(l9_465,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y);
float l9_466=l9_465;
vec2 l9_467;
float l9_468;
#if (SC_USE_UV_MIN_MAX_materialParamsTex)
...
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_469=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x==3;
}
#else
{
...
float l9_470=l9_464;
float l9_471=1.0;
sc_ClampUV(l9_470,materialParamsTexUvMinMax.x,materialParamsTexUvMinMax.z,l9_469,l9_471);
float l9_472=l9_470;
float l9_473=l9_471;
bool l9_474;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_474=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y==3;
}
#else
{
l9_474=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_475=l9_466;
float l9_476=l9_473;
sc_ClampUV(l9_475,materialParamsTexUvMinMax.y,materialParamsTexUvMinMax.w,l9_474,l9_476);
l9_468=l9_476;
...
#endif
vec2 l9_477=sc_TransformUV(l9_467,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform);
float l9_478=l9_477.x;
float l9_479=l9_468;
sc_SoftwareWrapLate(l9_478,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x,l9_462,l9_479);
float l9_480=l9_477.y;
float l9_481=l9_479;
sc_SoftwareWrapLate(l9_480,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y,l9_462,l9_481);
float l9_482=l9_481;
vec3 l9_483=sc_SamplingCoordsViewToGlobal(vec2(l9_478,l9_480),materialParamsTexLayout,materialParamsTexGetStereoViewIndex());
vec4 l9_484=texture(materialParamsTex,l9_483.xy,0.0);
vec4 l9_485;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_485=mix(materialParamsTexBorderColor,l9_484,vec4(l9_482));
}
#else
{
l9_485=l9_484;
...
#endif
float l9_486=l9_437.y*roughness;
vec3 l9_487;
...
#endif
float l9_488=clamp(l9_110,0.0,1.0);
...
#endif
if (dot(l9_5,l9_487)>=(-0.050000001))
{
uvec3 l9_489=uvec3(round((varPos-OriginNormalizationOffset)*OriginNormalizationScale));
position_and_mask=uvec4(l9_489.x,l9_489.y,l9_489.z,position_and_mask.w);
position_and_mask.w=uint(receiver_mask);
vec3 l9_490=abs(l9_487);
vec3 l9_491=l9_487/vec3(dot(l9_490,vec3(1.0)));
float l9_492=clamp(-l9_491.z,0.0,1.0);
float l9_493=l9_491.x;
float l9_494;
if (l9_493>=0.0)
{
l9_494=l9_492;
...
float l9_495=l9_493+l9_494;
float l9_496=l9_491.y;
float l9_497;
if (l9_496>=0.0)
{
l9_497=l9_492;
...
uvec2 l9_498=uvec2(packHalf2x16(vec2(l9_495,0.0)),packHalf2x16(vec2(l9_496+l9_497,0.0)));
normal_and_more=uvec4(l9_498.x,l9_498.y,normal_and_more.z,normal_and_more.w);
...
{
l9_499=uint(clamp(l9_486,0.0,1.0)*1000.0);
}
normal_and_more.w=l9_499|uint((receiverId%32)<<int(10u));
}
else
{
...
#endif
l9_282=N7_vec3srgbToLinear(l9_341)*reflectionIntensity;
}
#else
{
l9_282=vec3(0.0);
...
l9_392=vec3(0.0)+(N7_vec3srgbToLinear(l9_394)*ssPow(l9_448,rimExponent));
}
#else
{
l9_392=vec3(0.0);
...
float l9_472=l9_471;
vec3 l9_473=sc_SamplingCoordsViewToGlobal(vec2(l9_468,l9_470),materialParamsTexLayout,materialParamsTexGetStereoViewIndex());
vec4 l9_474=texture(materialParamsTexArrSC,l9_473,0.0);
vec4 l9_475;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_475=mix(materialParamsTexBorderColor,l9_474,vec4(l9_472));
}
#else
{
l9_475=l9_474;
...
#else
{
bool l9_476=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0));
float l9_477=l9_450.x;
sc_SoftwareWrapEarly(l9_477,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x);
float l9_478=l9_477;
float l9_479=l9_450.y;
sc_SoftwareWrapEarly(l9_479,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y);
float l9_480=l9_479;
vec2 l9_481;
float l9_482;
#if (SC_USE_UV_MIN_MAX_materialParamsTex)
...
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_483=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x==3;
}
#else
{
l9_483=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_484=l9_478;
float l9_485=1.0;
sc_ClampUV(l9_484,materialParamsTexUvMinMax.x,materialParamsTexUvMinMax.z,l9_483,l9_485);
float l9_486=l9_484;
float l9_487=l9_485;
bool l9_488;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_488=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y==3;
}
#else
{
...
float l9_489=l9_480;
float l9_490=l9_487;
sc_ClampUV(l9_489,materialParamsTexUvMinMax.y,materialParamsTexUvMinMax.w,l9_488,l9_490);
l9_482=l9_490;
l9_481=vec2(l9_486,l9_489);
}
#else
{
l9_482=1.0;
l9_481=vec2(l9_478,l9_480);
}
#endif
vec2 l9_491=sc_TransformUV(l9_481,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform);
float l9_492=l9_491.x;
float l9_493=l9_482;
sc_SoftwareWrapLate(l9_492,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x,l9_476,l9_493);
float l9_494=l9_491.y;
float l9_495=l9_493;
sc_SoftwareWrapLate(l9_494,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y,l9_476,l9_495);
float l9_496=l9_495;
vec3 l9_497=sc_SamplingCoordsViewToGlobal(vec2(l9_492,l9_494),materialParamsTexLayout,materialParamsTexGetStereoViewIndex());
vec4 l9_498=texture(materialParamsTex,l9_497.xy,0.0);
vec4 l9_499;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_499=mix(materialParamsTexBorderColor,l9_498,vec4(l9_496));
}
#else
{
l9_499=l9_498;
...
#endif
float l9_500=l9_451.x*metallic;
vec3 l9_501;
if (NODE_38_DROPLIST_ITEM==3)
{
l9_501=vec3(l9_451.z)*tempGlobals.VertexColor.xyz;
}
else
{
l9_501=vec3(l9_451.z);
}
vec3 l9_502;
#if (ENABLE_SPECULAR_AO)
{
vec3 l9_503=mix(vec3(0.039999999),l9_122.xyz*l9_500,vec3(l9_500));
l9_502=mix(vec3(1.0),mix((l9_503*(1.0-specularAoDarkening))*l9_503,vec3(1.0),vec3(l9_501.x)),vec3(specularAoIntensity));
}
#else
{
l9_502=vec3(1.0);
...
#endif
float l9_506=clamp(l9_123,0.0,1.0);
#if (sc_BlendMode_AlphaTest)
{
if (l9_506<alphaTestThreshold)
{
discard;
}
}
...
#if (ENABLE_STIPPLE_PATTERN_TEST)
{
if (l9_506<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
#endif
vec3 l9_507=max(l9_122.xyz,vec3(0.0));
vec4 l9_508;
#if (sc_ProjectiveShadowsCaster)
{
l9_508=vec4(l9_507,l9_506);
}
#else
{
l9_508=ngsCalculateLighting(l9_507,l9_506,l9_505,l9_7,l9_8,max(l9_449,vec3(0.0)),clamp(l9_500,0.0,1.0),clamp(l9_451.y*roughness,0.0,1.0),clamp(l9_501,vec3(0.0),vec3(1.0)),clamp(l9_504,vec3(0.0),vec3(1.0)));
}
#endif
vec4 l9_509=max(l9_508,vec4(0.0));
if (isProxyMode)
{
vec4 l9_510;
#if (sc_ProxyAlphaOne)
...
#endif
sc_writeFragData0Internal(max(l9_510,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_512;
#if (sc_ProjectiveShadowsCaster)
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_514=clamp(l9_509.w*2.0,0.0,1.0);
}
#else
{
float l9_515;
...
{
l9_515=clamp(dot(l9_509.xyz,vec3(l9_509.w)),0.0,1.0);
}
#else
{
float l9_516;
...
#if (sc_BlendMode_Multiply)
{
l9_517=(1.0-dot(l9_509.xyz,vec3(0.33333001)))*l9_509.w;
}
#else
{
float l9_518;
...
{
l9_518=(1.0-clamp(dot(l9_509.xyz,vec3(1.0)),0.0,1.0))*l9_509.w;
}
#else
{
float l9_519;
#if (sc_BlendMode_ColoredGlass)
{
l9_519=clamp(dot(l9_509.xyz,vec3(1.0)),0.0,1.0)*l9_509.w;
}
#else
{
float l9_520;
#if (sc_BlendMode_Add)
{
l9_520=clamp(dot(l9_509.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_521;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_521=clamp(dot(l9_509.xyz,vec3(1.0)),0.0,1.0)*l9_509.w;
}
#else
{
float l9_522;
...
{
l9_522=dot(l9_509.xyz,vec3(0.33333001))*l9_509.w;
}
#else
{
float l9_523;
#if (sc_BlendMode_Min)
{
l9_523=1.0-clamp(dot(l9_509.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_524;
#if (sc_BlendMode_Max)
{
l9_524=clamp(dot(l9_509.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_524=1.0;
...
#endif
l9_512=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_509.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_513);
}
#else
{
vec4 l9_525;
...
{
vec3 l9_527=sc_GetFramebufferColor().xyz;
vec3 l9_528=mix(l9_527,definedBlend(l9_527,l9_509.xyz).xyz,vec3(l9_509.w));
vec4 l9_529=vec4(l9_528.x,l9_528.y,l9_528.z,vec4(0.0).w);
l9_529.w=1.0;
l9_526=l9_529;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_531=l9_509.w;
l9_530=vec4(mix(vec3(1.0),l9_509.xyz,vec3(l9_531)),l9_531);
}
#else
{
vec4 l9_532;
...
{
float l9_533=l9_509.w;
float l9_534;
#if (sc_BlendMode_PremultipliedAlphaAuto)
{
l9_534=clamp(l9_533,0.0,1.0);
}
#else
{
l9_534=l9_533;
...
#endif
l9_532=vec4(l9_509.xyz*l9_534,l9_534);
}
#else
{
l9_532=l9_509;
...
{
l9_537=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_537=vec4(0.0);
...
vec4 l9_539=outputMotionVectorsIfNeeded(varPos,max(l9_538,vec4(0.0)));
