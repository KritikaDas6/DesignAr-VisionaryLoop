...
{
bool l9_20=(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0)&&(!(int(SC_USE_UV_MIN_MAX_planet_refl_map)!=0));
float l9_21=l9_18.x;
sc_SoftwareWrapEarly(l9_21,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x);
float l9_22=l9_21;
float l9_23=l9_18.y;
sc_SoftwareWrapEarly(l9_23,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y);
float l9_24=l9_23;
vec2 l9_25;
float l9_26;
...
{
l9_27=ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x==3;
}
#else
{
l9_27=(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0);
}
#endif
float l9_28=l9_22;
float l9_29=1.0;
sc_ClampUV(l9_28,planet_refl_mapUvMinMax.x,planet_refl_mapUvMinMax.z,l9_27,l9_29);
float l9_30=l9_28;
float l9_31=l9_29;
bool l9_32;
#if (SC_USE_CLAMP_TO_BORDER_planet_refl_map)
{
l9_32=ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y==3;
}
#else
{
l9_32=(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0);
}
#endif
float l9_33=l9_24;
float l9_34=l9_31;
sc_ClampUV(l9_33,planet_refl_mapUvMinMax.y,planet_refl_mapUvMinMax.w,l9_32,l9_34);
l9_26=l9_34;
...
#endif
vec2 l9_35=sc_TransformUV(l9_25,(int(SC_USE_UV_TRANSFORM_planet_refl_map)!=0),planet_refl_mapTransform);
float l9_36=l9_35.x;
float l9_37=l9_26;
sc_SoftwareWrapLate(l9_36,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x,l9_20,l9_37);
float l9_38=l9_35.y;
float l9_39=l9_37;
sc_SoftwareWrapLate(l9_38,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y,l9_20,l9_39);
float l9_40=l9_39;
vec3 l9_41=sc_SamplingCoordsViewToGlobal(vec2(l9_36,l9_38),planet_refl_mapLayout,planet_refl_mapGetStereoViewIndex());
vec4 l9_42=texture(planet_refl_mapArrSC,l9_41,0.0);
vec4 l9_43;
#if (SC_USE_CLAMP_TO_BORDER_planet_refl_map)
{
l9_43=mix(planet_refl_mapBorderColor,l9_42,vec4(l9_40));
}
#else
{
l9_43=l9_42;
...
#else
{
bool l9_44=(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0)&&(!(int(SC_USE_UV_MIN_MAX_planet_refl_map)!=0));
float l9_45=l9_18.x;
sc_SoftwareWrapEarly(l9_45,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x);
float l9_46=l9_45;
float l9_47=l9_18.y;
sc_SoftwareWrapEarly(l9_47,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y);
float l9_48=l9_47;
vec2 l9_49;
float l9_50;
#if (SC_USE_UV_MIN_MAX_planet_refl_map)
...
#if (SC_USE_CLAMP_TO_BORDER_planet_refl_map)
{
l9_51=ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x==3;
}
#else
{
l9_51=(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0);
}
#endif
float l9_52=l9_46;
float l9_53=1.0;
sc_ClampUV(l9_52,planet_refl_mapUvMinMax.x,planet_refl_mapUvMinMax.z,l9_51,l9_53);
float l9_54=l9_52;
float l9_55=l9_53;
bool l9_56;
#if (SC_USE_CLAMP_TO_BORDER_planet_refl_map)
{
l9_56=ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y==3;
}
#else
{
l9_56=(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0);
}
#endif
float l9_57=l9_48;
float l9_58=l9_55;
sc_ClampUV(l9_57,planet_refl_mapUvMinMax.y,planet_refl_mapUvMinMax.w,l9_56,l9_58);
l9_50=l9_58;
...
#endif
vec2 l9_59=sc_TransformUV(l9_49,(int(SC_USE_UV_TRANSFORM_planet_refl_map)!=0),planet_refl_mapTransform);
float l9_60=l9_59.x;
float l9_61=l9_50;
sc_SoftwareWrapLate(l9_60,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x,l9_44,l9_61);
float l9_62=l9_59.y;
float l9_63=l9_61;
sc_SoftwareWrapLate(l9_62,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y,l9_44,l9_63);
float l9_64=l9_63;
vec3 l9_65=sc_SamplingCoordsViewToGlobal(vec2(l9_60,l9_62),planet_refl_mapLayout,planet_refl_mapGetStereoViewIndex());
vec4 l9_66=texture(planet_refl_map,l9_65.xy,0.0);
vec4 l9_67;
#if (SC_USE_CLAMP_TO_BORDER_planet_refl_map)
{
l9_67=mix(planet_refl_mapBorderColor,l9_66,vec4(l9_64));
}
#else
{
l9_67=l9_66;
...
#endif
vec4 l9_68=vec4(reflIntensity)*l9_19;
float l9_69=radians(Port_Rotation_N003);
vec2 l9_70=l9_2-Port_Center_N003;
float l9_71=clamp((vec2(dot(vec2(cos(l9_69),sin(l9_69)),l9_70),0.0)+Port_Center_N003).x,0.0,1.0);
vec4 l9_72;
if (l9_71<colorRatio)
{
l9_72=mix(Tweak_N2,Tweak_N8,vec4(clamp(l9_71/colorRatio,0.0,1.0)));
}
else
{
l9_72=mix(Tweak_N8,Tweak_N9,vec4(clamp((l9_71-colorRatio)/(1.0-colorRatio),0.0,1.0)));
}
bool l9_73=PreviewEnabled==1;
bool l9_74;
if (l9_73)
{
l9_74=!l9_0;
...
vec4 l9_78=l9_68+l9_72;
vec4 l9_79;
#if (Tweak_N6Layout==2)
{
bool l9_80=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N6)!=0));
float l9_81=l9_1.x;
sc_SoftwareWrapEarly(l9_81,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x);
float l9_82=l9_81;
float l9_83=l9_1.y;
sc_SoftwareWrapEarly(l9_83,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y);
float l9_84=l9_83;
vec2 l9_85;
float l9_86;
...
{
l9_87=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x==3;
}
#else
{
l9_87=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0);
}
#endif
float l9_88=l9_82;
float l9_89=1.0;
sc_ClampUV(l9_88,Tweak_N6UvMinMax.x,Tweak_N6UvMinMax.z,l9_87,l9_89);
float l9_90=l9_88;
float l9_91=l9_89;
bool l9_92;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
l9_92=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y==3;
}
#else
{
l9_92=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0);
}
#endif
float l9_93=l9_84;
float l9_94=l9_91;
sc_ClampUV(l9_93,Tweak_N6UvMinMax.y,Tweak_N6UvMinMax.w,l9_92,l9_94);
l9_86=l9_94;
...
#endif
vec2 l9_95=sc_TransformUV(l9_85,(int(SC_USE_UV_TRANSFORM_Tweak_N6)!=0),Tweak_N6Transform);
float l9_96=l9_95.x;
float l9_97=l9_86;
sc_SoftwareWrapLate(l9_96,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x,l9_80,l9_97);
float l9_98=l9_95.y;
float l9_99=l9_97;
sc_SoftwareWrapLate(l9_98,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y,l9_80,l9_99);
float l9_100=l9_99;
vec3 l9_101=sc_SamplingCoordsViewToGlobal(vec2(l9_96,l9_98),Tweak_N6Layout,Tweak_N6GetStereoViewIndex());
vec4 l9_102=texture(Tweak_N6ArrSC,l9_101,0.0);
vec4 l9_103;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
l9_103=mix(Tweak_N6BorderColor,l9_102,vec4(l9_100));
}
#else
{
l9_103=l9_102;
...
#else
{
bool l9_104=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N6)!=0));
float l9_105=l9_1.x;
sc_SoftwareWrapEarly(l9_105,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x);
float l9_106=l9_105;
float l9_107=l9_1.y;
sc_SoftwareWrapEarly(l9_107,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y);
float l9_108=l9_107;
vec2 l9_109;
float l9_110;
#if (SC_USE_UV_MIN_MAX_Tweak_N6)
...
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
l9_111=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x==3;
}
#else
{
l9_111=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0);
}
#endif
float l9_112=l9_106;
float l9_113=1.0;
sc_ClampUV(l9_112,Tweak_N6UvMinMax.x,Tweak_N6UvMinMax.z,l9_111,l9_113);
float l9_114=l9_112;
float l9_115=l9_113;
bool l9_116;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
l9_116=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y==3;
}
#else
{
l9_116=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0);
}
#endif
float l9_117=l9_108;
float l9_118=l9_115;
sc_ClampUV(l9_117,Tweak_N6UvMinMax.y,Tweak_N6UvMinMax.w,l9_116,l9_118);
l9_110=l9_118;
...
#endif
vec2 l9_119=sc_TransformUV(l9_109,(int(SC_USE_UV_TRANSFORM_Tweak_N6)!=0),Tweak_N6Transform);
float l9_120=l9_119.x;
float l9_121=l9_110;
sc_SoftwareWrapLate(l9_120,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x,l9_104,l9_121);
float l9_122=l9_119.y;
float l9_123=l9_121;
sc_SoftwareWrapLate(l9_122,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y,l9_104,l9_123);
float l9_124=l9_123;
vec3 l9_125=sc_SamplingCoordsViewToGlobal(vec2(l9_120,l9_122),Tweak_N6Layout,Tweak_N6GetStereoViewIndex());
vec4 l9_126=texture(Tweak_N6,l9_125.xy,0.0);
vec4 l9_127;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
l9_127=mix(Tweak_N6BorderColor,l9_126,vec4(l9_124));
}
#else
{
l9_127=l9_126;
...
#endif
vec3 l9_128=l9_78.xyz;
vec3 l9_129=mix(l9_128,(l9_79.xyz*l9_128).xyz,vec3(l9_79.w));
float l9_130=l9_78.w;
vec4 l9_131=vec4(l9_129.x,l9_129.y,l9_129.z,vec4(0.0).w);
l9_131.w=l9_130;
#if (sc_BlendMode_AlphaTest)
{
if (l9_130<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_130<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0Internal(max(l9_132,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_134;
...
{
l9_136=clamp(l9_130*2.0,0.0,1.0);
}
#else
{
float l9_137;
...
{
l9_137=clamp(dot(l9_131.xyz,vec3(l9_130)),0.0,1.0);
}
#else
{
float l9_138;
...
{
l9_139=(1.0-dot(l9_131.xyz,vec3(0.33333001)))*l9_130;
}
#else
{
float l9_140;
...
{
l9_140=(1.0-clamp(dot(l9_131.xyz,vec3(1.0)),0.0,1.0))*l9_130;
}
#else
{
float l9_141;
...
{
l9_141=clamp(dot(l9_131.xyz,vec3(1.0)),0.0,1.0)*l9_130;
}
#else
{
float l9_142;
#if (sc_BlendMode_Add)
{
l9_142=clamp(dot(l9_131.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_143;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_143=clamp(dot(l9_131.xyz,vec3(1.0)),0.0,1.0)*l9_130;
}
#else
{
float l9_144;
...
{
l9_144=dot(l9_131.xyz,vec3(0.33333001))*l9_130;
}
#else
{
float l9_145;
#if (sc_BlendMode_Min)
{
l9_145=1.0-clamp(dot(l9_131.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_146;
#if (sc_BlendMode_Max)
{
l9_146=clamp(dot(l9_131.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_146=1.0;
...
#endif
l9_134=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_131.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_135);
}
#else
{
vec4 l9_147;
...
{
l9_155=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_153,sc_ScreenTextureLayout,l9_154),0.0);
}
#else
{
l9_155=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_153,sc_ScreenTextureLayout,l9_154).xy,0.0);
}
#endif
l9_149=l9_155;
}
...
{
vec4 l9_157=l9_149;
l9_157.x=l9_149.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_156=l9_157;
}
#else
{
...
#endif
vec3 l9_158=mix(l9_156.xyz,definedBlend(l9_156.xyz,l9_131.xyz).xyz,vec3(l9_130));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_160=vec4(mix(vec3(1.0),l9_131.xyz,vec3(l9_130)),l9_130);
}
#else
{
vec4 l9_161;
...
#endif
l9_161=vec4(l9_131.xyz*l9_162,l9_162);
}
#else
{
l9_161=l9_131;
...
{
l9_165=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_165=vec4(0.0);
...
vec4 l9_167=outputMotionVectorsIfNeeded(varPos,max(l9_166,vec4(0.0)));
...
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_170).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_171=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_170).xy);
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_183).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_188==0)
{
l9_191=texture(sc_OITAlpha0,l9_183);
l9_190=texture(sc_OITDepthLow0,l9_183);
l9_189=texture(sc_OITDepthHigh0,l9_183);
}
else
{
l9_191=vec4(0.0);
...
if (l9_188==1)
{
l9_194=texture(sc_OITAlpha1,l9_183);
l9_193=texture(sc_OITDepthLow1,l9_183);
l9_192=texture(sc_OITDepthHigh1,l9_183);
}
else
{
l9_194=l9_191;
...
vec4 l9_209=texture(sc_OITFilteredDepthBoundsTexture,l9_183);
