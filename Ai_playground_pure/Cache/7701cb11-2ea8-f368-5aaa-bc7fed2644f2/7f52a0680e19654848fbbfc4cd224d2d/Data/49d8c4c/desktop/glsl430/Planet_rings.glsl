...
//spec_const bool sc_ProxyAlphaOne 67 0
...
#endif
sc_writeFragData0Internal(max(l9_39,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_41;
...
{
l9_62=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_60,sc_ScreenTextureLayout,l9_61),0.0);
}
#else
{
l9_62=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_60,sc_ScreenTextureLayout,l9_61).xy,0.0);
}
#endif
l9_56=l9_62;
}
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_76-0.0039215689)),min(1.0,l9_76+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
sc_writeFragData0Internal(vec4(packValue(l9_78),packValue(l9_78),packValue(l9_78),packValue(l9_78)),sc_UniformConstants.x,sc_ShaderCacheConstant);
...
sc_writeFragData0Internal(l9_120,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
