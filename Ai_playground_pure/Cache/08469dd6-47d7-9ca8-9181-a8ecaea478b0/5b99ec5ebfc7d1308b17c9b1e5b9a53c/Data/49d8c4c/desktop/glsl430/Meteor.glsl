...
#endif
sc_writeFragData0Internal(max(l9_51,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_53;
...
{
l9_55=clamp(l9_2.w*2.0,0.0,1.0);
}
#else
{
float l9_56;
...
{
l9_56=clamp(dot(l9_2.xyz,vec3(l9_2.w)),0.0,1.0);
}
#else
{
float l9_57;
...
{
l9_58=(1.0-dot(l9_2.xyz,vec3(0.33333001)))*l9_2.w;
}
#else
{
float l9_59;
...
{
l9_59=(1.0-clamp(dot(l9_2.xyz,vec3(1.0)),0.0,1.0))*l9_2.w;
}
#else
{
float l9_60;
...
{
l9_60=clamp(dot(l9_2.xyz,vec3(1.0)),0.0,1.0)*l9_2.w;
}
#else
{
float l9_61;
#if (sc_BlendMode_Add)
{
l9_61=clamp(dot(l9_2.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_62;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_62=clamp(dot(l9_2.xyz,vec3(1.0)),0.0,1.0)*l9_2.w;
}
#else
{
float l9_63;
...
{
l9_63=dot(l9_2.xyz,vec3(0.33333001))*l9_2.w;
}
#else
{
float l9_64;
#if (sc_BlendMode_Min)
{
l9_64=1.0-clamp(dot(l9_2.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_65;
#if (sc_BlendMode_Max)
{
l9_65=clamp(dot(l9_2.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_65=1.0;
...
#endif
l9_53=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_2.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_54);
}
#else
{
vec4 l9_66;
...
{
l9_74=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_72,sc_ScreenTextureLayout,l9_73),0.0);
}
#else
{
l9_74=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_72,sc_ScreenTextureLayout,l9_73).xy,0.0);
}
#endif
l9_68=l9_74;
}
...
#endif
vec3 l9_77=mix(l9_75.xyz,definedBlend(l9_75.xyz,l9_2.xyz).xyz,vec3(l9_2.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_79=vec4(mix(vec3(1.0),l9_2.xyz,vec3(l9_2.w)),l9_2.w);
}
#else
{
vec4 l9_80;
...
#endif
l9_80=vec4(l9_2.xyz*l9_81,l9_81);
}
#else
{
l9_80=l9_2;
