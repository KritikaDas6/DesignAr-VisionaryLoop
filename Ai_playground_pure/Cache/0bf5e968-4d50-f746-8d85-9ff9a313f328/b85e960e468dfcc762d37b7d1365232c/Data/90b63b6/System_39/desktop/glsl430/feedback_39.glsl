...
{
l9_1=texture(renderTarget0ArrSC,sc_SamplingCoordsViewToGlobal(varPackedTex.xy,renderTarget0Layout,l9_0),0.0);
}
#else
{
l9_1=texture(renderTarget0,sc_SamplingCoordsViewToGlobal(varPackedTex.xy,renderTarget0Layout,l9_0).xy,0.0);
}
#endif
int l9_2;
...
{
l9_3=texture(renderTarget1ArrSC,sc_SamplingCoordsViewToGlobal(varPackedTex.xy,renderTarget1Layout,l9_2),0.0);
}
#else
{
l9_3=texture(renderTarget1,sc_SamplingCoordsViewToGlobal(varPackedTex.xy,renderTarget1Layout,l9_2).xy,0.0);
}
#endif
int l9_4;
...
{
l9_5=texture(renderTarget2ArrSC,sc_SamplingCoordsViewToGlobal(varPackedTex.xy,renderTarget2Layout,l9_4),0.0);
}
#else
{
l9_5=texture(renderTarget2,sc_SamplingCoordsViewToGlobal(varPackedTex.xy,renderTarget2Layout,l9_4).xy,0.0);
}
#endif
int l9_6;
...
{
l9_7=texture(renderTarget3ArrSC,sc_SamplingCoordsViewToGlobal(varPackedTex.xy,renderTarget3Layout,l9_6),0.0);
}
#else
{
l9_7=texture(renderTarget3,sc_SamplingCoordsViewToGlobal(varPackedTex.xy,renderTarget3Layout,l9_6).xy,0.0);
}
#endif
if (dot(((l9_1+l9_3)+l9_5)+l9_7,vec4(0.23454))==0.34231836)
{
discard;
}
