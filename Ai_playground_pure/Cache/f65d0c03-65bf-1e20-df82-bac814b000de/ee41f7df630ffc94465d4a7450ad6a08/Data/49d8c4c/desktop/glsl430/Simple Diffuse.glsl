...
//sampler sampler sc_RayTracedAoTextureSmpSC 0:28
//sampler sampler sc_RayTracedDiffIndTextureSmpSC 0:29
//sampler sampler sc_RayTracedShadowTextureSmpSC 0:31
...
//sampler sampler z_hitIdAndBarycentricSmp 0:36
//sampler sampler z_rayDirectionsSmpSC 0:37
//texture texture2D intensityTexture 0:3:0:24
//texture texture2D sc_EnvmapDiffuse 0:4:0:25
//texture texture2D sc_EnvmapSpecular 0:5:0:26
//texture texture2D sc_OITAlpha0 0:6:0:27
//texture texture2D sc_OITAlpha1 0:7:0:27
//texture texture2D sc_OITDepthHigh0 0:8:0:27
//texture texture2D sc_OITDepthHigh1 0:9:0:27
//texture texture2D sc_OITDepthLow0 0:10:0:27
//texture texture2D sc_OITDepthLow1 0:11:0:27
//texture texture2D sc_OITFilteredDepthBoundsTexture 0:12:0:27
//texture texture2D sc_OITFrontDepthTexture 0:13:0:27
//texture texture2D sc_RayTracedAoTexture 0:14:0:28
//texture texture2D sc_RayTracedDiffIndTexture 0:15:0:29
//texture texture2D sc_RayTracedShadowTexture 0:17:0:31
...
//texture utexture2D z_hitIdAndBarycentric 0:22:0:36
//texture texture2D z_rayDirections 0:23:0:37
//texture texture2DArray intensityTextureArrSC 0:38:0:24
//texture texture2DArray sc_EnvmapDiffuseArrSC 0:39:0:25
//texture texture2DArray sc_EnvmapSpecularArrSC 0:40:0:26
//texture texture2DArray sc_RayTracedAoTextureArrSC 0:41:0:28
//texture texture2DArray sc_RayTracedDiffIndTextureArrSC 0:42:0:29
//texture texture2DArray sc_RayTracedShadowTextureArrSC 0:44:0:31
//texture texture2DArray sc_ScreenTextureArrSC 0:45:0:33
...
//spec_const bool sc_GetFramebufferColorInvalidUsageMarker 56 0
//spec_const bool sc_HasDiffuseEnvmap 57 0
...
//spec_const bool sc_RayTracedAoTextureHasSwappedViews 72 0
//spec_const bool sc_RayTracedDiffIndTextureHasSwappedViews 73 0
//spec_const bool sc_RayTracedShadowTextureHasSwappedViews 74 0
...
//spec_const int sc_RayTracedAoTextureLayout 103 0
//spec_const int sc_RayTracedDiffIndTextureLayout 104 0
//spec_const int sc_RayTracedShadowTextureLayout 105 0
...
//spec_const int sc_StereoViewID 112 0
//SG_REFLECTION_END
...
#endif
float l9_0=clamp(baseColor.w,0.0,1.0);
...
l9_89=mix(l9_69,l9_90.xyz,vec3(l9_90.w));
}
else
{
l9_89=l9_69;
...
l9_117=vec3(0.0);
l9_116=vec3(0.0);
l9_115=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_13,vec3(l9_0));
l9_114=1.0;
}
#else
{
...
if (receivesRayTracedAo)
{
l9_119=l9_13*(l9_117+(l9_116*vec3(1.0-sampleRayTracedAo())));
}
else
{
l9_119=l9_13*(l9_117+(l9_116*l9_11));
}
vec3 l9_120=l9_38*l9_10;
vec3 l9_121;
if (l9_118)
{
l9_121=l9_119*srgbToLinear(l9_114);
}
else
{
l9_121=l9_119;
...
vec3 l9_123=(l9_122+l9_6)+l9_115;
float l9_124=l9_123.x;
vec4 l9_125=vec4(l9_124,l9_123.yz,l9_114);
vec4 l9_126;
#if (sc_IsEditor)
{
vec4 l9_127=l9_125;
...
{
l9_2=normalize(sc_Camera.position-varPos);
l9_1=varPos;
l9_0=normalize(varNormal);
}
vec3 l9_4;
...
#endif
float l9_5=clamp(baseColor.w,0.0,1.0);
#if (sc_BlendMode_AlphaTest)
{
...
#endif
vec3 l9_6=max(baseColor.xyz,vec3(0.0));
vec4 l9_7;
#if (sc_ProjectiveShadowsCaster)
{
l9_7=vec4(l9_6,l9_5);
...
#else
{
l9_7=ngsCalculateLighting(l9_6,l9_5,l9_4,l9_1,l9_2,Port_Emissive_N000,0.0,1.0,Port_AO_N000,vec3(1.0));
}
#endif
...
#endif
sc_writeFragData0Internal(max(l9_9,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_11;
#if (sc_ProjectiveShadowsCaster)
...
{
float l9_30=l9_8.w;
l9_29=vec4(mix(vec3(1.0),l9_8.xyz,vec3(l9_30)),l9_30);
}
#else
{
vec4 l9_31;
...
#endif
l9_31=vec4(l9_8.xyz*l9_33,l9_33);
}
#else
{
l9_31=l9_8;
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_40-0.0039215689)),min(1.0,l9_40+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
sc_writeFragData0Internal(vec4(packValue(l9_42),packValue(l9_42),packValue(l9_42),packValue(l9_42)),sc_UniformConstants.x,sc_ShaderCacheConstant);
