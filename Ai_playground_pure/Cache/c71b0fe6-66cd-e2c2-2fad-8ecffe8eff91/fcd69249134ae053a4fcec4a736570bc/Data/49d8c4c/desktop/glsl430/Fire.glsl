...
#if (sc_FramebufferFetch)
{
vec4 l9_108=sc_readFragData0_Platform();
vec4 l9_109;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_110=l9_108;
l9_110.x=l9_108.x+_sc_framebufferFetchMarker;
l9_109=l9_110;
}
#else
{
...
{
l9_113=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_111,sc_ScreenTextureLayout,l9_112),0.0);
}
#else
{
l9_113=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_111,sc_ScreenTextureLayout,l9_112).xy,0.0);
}
#endif
l9_107=l9_113;
}
...
{
vec4 l9_115=l9_107;
l9_115.x=l9_107.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_114=l9_115;
}
#else
{
...
#endif
vec3 l9_116=mix(l9_114.xyz,definedBlend(l9_114.xyz,l9_91.xyz).xyz,vec3(Port_Value2_N001));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_118=vec4(mix(vec3(1.0),l9_91.xyz,vec3(Port_Value2_N001)),Port_Value2_N001);
}
#else
{
vec4 l9_119;
...
{
l9_120=clamp(Port_Value2_N001,0.0,1.0);
}
#else
{
l9_120=Port_Value2_N001;
}
#endif
l9_119=vec4(l9_91.xyz*l9_120,l9_120);
}
#else
{
l9_119=l9_91;
...
{
l9_123=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_123=vec4(0.0);
...
vec4 l9_125=outputMotionVectorsIfNeeded(varPos,max(l9_124,vec4(0.0)));
vec4 l9_126=clamp(l9_125,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_127=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_127-0.0039215689)),min(1.0,l9_127+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#endif
int l9_129=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_128).xy);
float l9_130=packValue(l9_129);
int l9_137=int(l9_126.w*255.0);
float l9_138=packValue(l9_137);
sc_writeFragData0Internal(vec4(packValue(l9_129),packValue(l9_129),packValue(l9_129),packValue(l9_129)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_130,packValue(l9_129),packValue(l9_129),packValue(l9_129)));
sc_writeFragData2(vec4(l9_138,packValue(l9_137),packValue(l9_137),packValue(l9_137)));
...
if (l9_146==0)
{
l9_149=texture(sc_OITAlpha0,l9_141);
l9_148=texture(sc_OITDepthLow0,l9_141);
l9_147=texture(sc_OITDepthHigh0,l9_141);
}
else
{
l9_149=vec4(0.0);
...
if (l9_146==1)
{
l9_152=texture(sc_OITAlpha1,l9_141);
l9_151=texture(sc_OITDepthLow1,l9_141);
l9_150=texture(sc_OITDepthHigh1,l9_141);
}
else
{
l9_152=l9_149;
...
if (any(notEqual(l9_150,vec4(0.0)))||any(notEqual(l9_151,vec4(0.0))))
{
int l9_153[8]=l9_142;
unpackValues(l9_150.w,l9_146,l9_153);
unpackValues(l9_150.z,l9_146,l9_153);
unpackValues(l9_150.y,l9_146,l9_153);
unpackValues(l9_150.x,l9_146,l9_153);
unpackValues(l9_151.w,l9_146,l9_153);
unpackValues(l9_151.z,l9_146,l9_153);
unpackValues(l9_151.y,l9_146,l9_153);
unpackValues(l9_151.x,l9_146,l9_153);
int l9_162[8]=l9_143;
unpackValues(l9_152.w,l9_146,l9_162);
unpackValues(l9_152.z,l9_146,l9_162);
unpackValues(l9_152.y,l9_146,l9_162);
unpackValues(l9_152.x,l9_146,l9_162);
}
l9_146++;
continue;
}
...
vec4 l9_167=texture(sc_OITFilteredDepthBoundsTexture,l9_141);
vec2 l9_168=l9_167.xy;
int l9_169;
#if (sc_SkinBonesCount>0)
{
l9_169=encodeDepth(((1.0-l9_167.x)*1000.0)+getDepthOrderingEpsilon(),l9_168);
}
#else
{
l9_169=0;
...
#endif
int l9_170=encodeDepth(viewSpaceDepth(),l9_168);
vec4 l9_171;
l9_171=l9_126*l9_126.w;
vec4 l9_172;
int l9_173=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_173<8)
{
int l9_174=l9_142[l9_173];
int l9_175=l9_170-l9_169;
bool l9_176=l9_174<l9_175;
bool l9_177;
if (l9_176)
{
l9_177=l9_142[l9_173]>0;
}
else
{
l9_177=l9_176;
...
if (l9_177)
{
vec3 l9_178=l9_171.xyz*(1.0-(float(l9_143[l9_173])/255.0));
l9_172=vec4(l9_178.x,l9_178.y,l9_178.z,l9_171.w);
}
else
{
l9_172=l9_171;
