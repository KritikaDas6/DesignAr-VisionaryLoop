...
//sampler sampler Tweak_N125SmpSC 0:21
...
//texture texture2D Tweak_N125 0:3:0:21
...
//texture texture2DArray Tweak_N125ArrSC 0:32:0:21
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N125 79 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 80 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N125 81 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 82 -1
//spec_const int Tweak_N125Layout 83 0
...
#endif
#ifndef Tweak_N125HasSwappedViews
#define Tweak_N125HasSwappedViews 0
#elif Tweak_N125HasSwappedViews==1
#undef Tweak_N125HasSwappedViews
#define Tweak_N125HasSwappedViews 1
#endif
#ifndef Tweak_N125Layout
#define Tweak_N125Layout 0
#endif
#ifndef sc_DepthOnly
...
#endif
#ifndef SC_USE_UV_TRANSFORM_Tweak_N125
#define SC_USE_UV_TRANSFORM_Tweak_N125 0
#elif SC_USE_UV_TRANSFORM_Tweak_N125==1
#undef SC_USE_UV_TRANSFORM_Tweak_N125
#define SC_USE_UV_TRANSFORM_Tweak_N125 1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_U_Tweak_N125
#define SC_SOFTWARE_WRAP_MODE_U_Tweak_N125 -1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_V_Tweak_N125
#define SC_SOFTWARE_WRAP_MODE_V_Tweak_N125 -1
#endif
#ifndef SC_USE_UV_MIN_MAX_Tweak_N125
#define SC_USE_UV_MIN_MAX_Tweak_N125 0
#elif SC_USE_UV_MIN_MAX_Tweak_N125==1
#undef SC_USE_UV_MIN_MAX_Tweak_N125
#define SC_USE_UV_MIN_MAX_Tweak_N125 1
#endif
#ifndef SC_USE_CLAMP_TO_BORDER_Tweak_N125
#define SC_USE_CLAMP_TO_BORDER_Tweak_N125 0
#elif SC_USE_CLAMP_TO_BORDER_Tweak_N125==1
#undef SC_USE_CLAMP_TO_BORDER_Tweak_N125
#define SC_USE_CLAMP_TO_BORDER_Tweak_N125 1
#endif
layout(binding=1,std430) readonly buffer layoutVertices
{
float _Vertices[1];
...
uniform float activeHover;
uniform float width;
uniform float animationOff;
uniform vec4 sc_Time;
uniform vec2 Port_Center_N155;
uniform vec2 Port_Scale_N155;
uniform float Port_Input1_N156;
uniform float Port_Input1_N162;
uniform float Port_Input1_N167;
uniform float Port_Input1_N169;
uniform float Port_Value_N178;
uniform vec2 Port_Center_N177;
uniform float Port_Speed_N176;
uniform vec2 Port_Direction_N176;
uniform mat3 Tweak_N125Transform;
uniform vec4 Tweak_N125UvMinMax;
uniform vec4 Tweak_N125BorderColor;
uniform float Port_Value_N173;
uniform float Port_Input0_N152;
uniform float Port_Input1_N152;
uniform float Port_Speed_N183;
uniform vec2 Port_Direction_N183;
uniform vec2 Port_Center_N182;
...
uniform float Port_Input0_N010;
uniform float Port_RangeMinA_N009;
uniform float Port_RangeMaxA_N009;
uniform float Port_RangeMinB_N009;
uniform vec2 Port_center_N006;
uniform float Port_feather_N006;
uniform vec2 Port_center_N012;
uniform float Port_feather_N012;
uniform int PreviewEnabled;
uniform usampler2D z_hitIdAndBarycentric;
uniform sampler2D z_rayDirections;
uniform sampler2D Tweak_N125;
uniform sampler2DArray Tweak_N125ArrSC;
...
int Tweak_N125GetStereoViewIndex()
{
int l9_0;
#if (Tweak_N125HasSwappedViews)
{
...
vec2 l9_2=l9_0-Port_Center_N155;
vec2 l9_3=(l9_2*Port_Scale_N155)+Port_Center_N155;
vec2 l9_4=l9_3-vec2(Port_Input1_N156);
vec2 l9_5=l9_4*l9_4;
float l9_6=l9_5.x+l9_5.y;
float l9_7;
if (l9_6<=0.0)
{
l9_7=0.0;
...
vec2 l9_8=l9_3-vec2(Port_Input1_N162);
vec2 l9_9=vec2(l9_7,(atan(l9_8.y,l9_8.x)/(3.1415927*Port_Input1_N167))+Port_Input1_N169);
vec2 l9_10=l9_0-Port_Center_N177;
vec2 l9_11=((l9_10*vec2((Port_Value_N178+0.001)-0.001))+Port_Center_N177)+(Port_Direction_N176*(sc_Time.x*Port_Speed_N176));
vec4 l9_12;
#if (Tweak_N125Layout==2)
{
bool l9_13=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N125)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N125)!=0));
float l9_14=l9_11.x;
sc_SoftwareWrapEarly(l9_14,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N125,SC_SOFTWARE_WRAP_MODE_V_Tweak_N125).x);
float l9_15=l9_14;
float l9_16=l9_11.y;
sc_SoftwareWrapEarly(l9_16,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N125,SC_SOFTWARE_WRAP_MODE_V_Tweak_N125).y);
float l9_17=l9_16;
vec2 l9_18;
float l9_19;
#if (SC_USE_UV_MIN_MAX_Tweak_N125)
{
bool l9_20;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N125)
{
l9_20=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N125,SC_SOFTWARE_WRAP_MODE_V_Tweak_N125).x==3;
}
#else
{
l9_20=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N125)!=0);
}
#endif
float l9_21=l9_15;
float l9_22=1.0;
sc_ClampUV(l9_21,Tweak_N125UvMinMax.x,Tweak_N125UvMinMax.z,l9_20,l9_22);
float l9_23=l9_21;
float l9_24=l9_22;
bool l9_25;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N125)
{
l9_25=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N125,SC_SOFTWARE_WRAP_MODE_V_Tweak_N125).y==3;
}
#else
{
l9_25=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N125)!=0);
}
#endif
float l9_26=l9_17;
float l9_27=l9_24;
sc_ClampUV(l9_26,Tweak_N125UvMinMax.y,Tweak_N125UvMinMax.w,l9_25,l9_27);
l9_19=l9_27;
...
#endif
vec2 l9_28=sc_TransformUV(l9_18,(int(SC_USE_UV_TRANSFORM_Tweak_N125)!=0),Tweak_N125Transform);
float l9_29=l9_28.x;
float l9_30=l9_19;
sc_SoftwareWrapLate(l9_29,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N125,SC_SOFTWARE_WRAP_MODE_V_Tweak_N125).x,l9_13,l9_30);
float l9_31=l9_28.y;
float l9_32=l9_30;
sc_SoftwareWrapLate(l9_31,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N125,SC_SOFTWARE_WRAP_MODE_V_Tweak_N125).y,l9_13,l9_32);
float l9_33=l9_32;
vec3 l9_34=sc_SamplingCoordsViewToGlobal(vec2(l9_29,l9_31),Tweak_N125Layout,Tweak_N125GetStereoViewIndex());
vec4 l9_35=texture(Tweak_N125ArrSC,l9_34,0.0);
vec4 l9_36;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N125)
{
l9_36=mix(Tweak_N125BorderColor,l9_35,vec4(l9_33));
}
#else
{
l9_36=l9_35;
...
#else
{
bool l9_37=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N125)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N125)!=0));
float l9_38=l9_11.x;
sc_SoftwareWrapEarly(l9_38,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N125,SC_SOFTWARE_WRAP_MODE_V_Tweak_N125).x);
float l9_39=l9_38;
float l9_40=l9_11.y;
sc_SoftwareWrapEarly(l9_40,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N125,SC_SOFTWARE_WRAP_MODE_V_Tweak_N125).y);
float l9_41=l9_40;
vec2 l9_42;
float l9_43;
#if (SC_USE_UV_MIN_MAX_Tweak_N125)
...
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N125)
{
l9_44=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N125,SC_SOFTWARE_WRAP_MODE_V_Tweak_N125).x==3;
}
#else
{
l9_44=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N125)!=0);
}
#endif
float l9_45=l9_39;
float l9_46=1.0;
sc_ClampUV(l9_45,Tweak_N125UvMinMax.x,Tweak_N125UvMinMax.z,l9_44,l9_46);
float l9_47=l9_45;
float l9_48=l9_46;
bool l9_49;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N125)
{
l9_49=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N125,SC_SOFTWARE_WRAP_MODE_V_Tweak_N125).y==3;
}
#else
{
l9_49=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N125)!=0);
}
#endif
float l9_50=l9_41;
float l9_51=l9_48;
sc_ClampUV(l9_50,Tweak_N125UvMinMax.y,Tweak_N125UvMinMax.w,l9_49,l9_51);
l9_43=l9_51;
...
#endif
vec2 l9_52=sc_TransformUV(l9_42,(int(SC_USE_UV_TRANSFORM_Tweak_N125)!=0),Tweak_N125Transform);
float l9_53=l9_52.x;
float l9_54=l9_43;
sc_SoftwareWrapLate(l9_53,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N125,SC_SOFTWARE_WRAP_MODE_V_Tweak_N125).x,l9_37,l9_54);
float l9_55=l9_52.y;
float l9_56=l9_54;
sc_SoftwareWrapLate(l9_55,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N125,SC_SOFTWARE_WRAP_MODE_V_Tweak_N125).y,l9_37,l9_56);
float l9_57=l9_56;
vec3 l9_58=sc_SamplingCoordsViewToGlobal(vec2(l9_53,l9_55),Tweak_N125Layout,Tweak_N125GetStereoViewIndex());
vec4 l9_59=texture(Tweak_N125,l9_58.xy,0.0);
vec4 l9_60;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N125)
{
l9_60=mix(Tweak_N125BorderColor,l9_59,vec4(l9_57));
}
#else
{
l9_60=l9_59;
...
#endif
float l9_61=l9_7+(l9_12.y*((Port_Value_N173+0.001)-0.001));
vec2 l9_62=(((l9_9+(Port_Direction_N183*(sc_Time.x*Port_Speed_N183)))-Port_Center_N182)*Port_Scale_N182)+Port_Center_N182;
vec4 l9_63;
#if (Tweak_N125Layout==2)
{
bool l9_64=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N125)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N125)!=0));
float l9_65=l9_62.x;
sc_SoftwareWrapEarly(l9_65,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N125,SC_SOFTWARE_WRAP_MODE_V_Tweak_N125).x);
float l9_66=l9_65;
float l9_67=l9_62.y;
sc_SoftwareWrapEarly(l9_67,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N125,SC_SOFTWARE_WRAP_MODE_V_Tweak_N125).y);
float l9_68=l9_67;
vec2 l9_69;
float l9_70;
#if (SC_USE_UV_MIN_MAX_Tweak_N125)
...
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N125)
{
l9_71=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N125,SC_SOFTWARE_WRAP_MODE_V_Tweak_N125).x==3;
}
#else
{
l9_71=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N125)!=0);
}
#endif
float l9_72=l9_66;
float l9_73=1.0;
sc_ClampUV(l9_72,Tweak_N125UvMinMax.x,Tweak_N125UvMinMax.z,l9_71,l9_73);
float l9_74=l9_72;
float l9_75=l9_73;
bool l9_76;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N125)
{
l9_76=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N125,SC_SOFTWARE_WRAP_MODE_V_Tweak_N125).y==3;
}
#else
{
l9_76=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N125)!=0);
}
#endif
float l9_77=l9_68;
float l9_78=l9_75;
sc_ClampUV(l9_77,Tweak_N125UvMinMax.y,Tweak_N125UvMinMax.w,l9_76,l9_78);
l9_70=l9_78;
...
#endif
vec2 l9_79=sc_TransformUV(l9_69,(int(SC_USE_UV_TRANSFORM_Tweak_N125)!=0),Tweak_N125Transform);
float l9_80=l9_79.x;
float l9_81=l9_70;
sc_SoftwareWrapLate(l9_80,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N125,SC_SOFTWARE_WRAP_MODE_V_Tweak_N125).x,l9_64,l9_81);
float l9_82=l9_79.y;
float l9_83=l9_81;
sc_SoftwareWrapLate(l9_82,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N125,SC_SOFTWARE_WRAP_MODE_V_Tweak_N125).y,l9_64,l9_83);
float l9_84=l9_83;
vec3 l9_85=sc_SamplingCoordsViewToGlobal(vec2(l9_80,l9_82),Tweak_N125Layout,Tweak_N125GetStereoViewIndex());
vec4 l9_86=texture(Tweak_N125ArrSC,l9_85,0.0);
vec4 l9_87;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N125)
{
l9_87=mix(Tweak_N125BorderColor,l9_86,vec4(l9_84));
}
#else
{
l9_87=l9_86;
...
#else
{
bool l9_88=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N125)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N125)!=0));
float l9_89=l9_62.x;
sc_SoftwareWrapEarly(l9_89,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N125,SC_SOFTWARE_WRAP_MODE_V_Tweak_N125).x);
float l9_90=l9_89;
float l9_91=l9_62.y;
sc_SoftwareWrapEarly(l9_91,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N125,SC_SOFTWARE_WRAP_MODE_V_Tweak_N125).y);
float l9_92=l9_91;
vec2 l9_93;
float l9_94;
#if (SC_USE_UV_MIN_MAX_Tweak_N125)
...
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N125)
{
l9_95=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N125,SC_SOFTWARE_WRAP_MODE_V_Tweak_N125).x==3;
}
#else
{
l9_95=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N125)!=0);
}
#endif
float l9_96=l9_90;
float l9_97=1.0;
sc_ClampUV(l9_96,Tweak_N125UvMinMax.x,Tweak_N125UvMinMax.z,l9_95,l9_97);
float l9_98=l9_96;
float l9_99=l9_97;
bool l9_100;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N125)
{
l9_100=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N125,SC_SOFTWARE_WRAP_MODE_V_Tweak_N125).y==3;
}
#else
{
l9_100=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N125)!=0);
}
#endif
float l9_101=l9_92;
float l9_102=l9_99;
sc_ClampUV(l9_101,Tweak_N125UvMinMax.y,Tweak_N125UvMinMax.w,l9_100,l9_102);
l9_94=l9_102;
...
#endif
vec2 l9_103=sc_TransformUV(l9_93,(int(SC_USE_UV_TRANSFORM_Tweak_N125)!=0),Tweak_N125Transform);
float l9_104=l9_103.x;
float l9_105=l9_94;
sc_SoftwareWrapLate(l9_104,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N125,SC_SOFTWARE_WRAP_MODE_V_Tweak_N125).x,l9_88,l9_105);
float l9_106=l9_103.y;
float l9_107=l9_105;
sc_SoftwareWrapLate(l9_106,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N125,SC_SOFTWARE_WRAP_MODE_V_Tweak_N125).y,l9_88,l9_107);
float l9_108=l9_107;
vec3 l9_109=sc_SamplingCoordsViewToGlobal(vec2(l9_104,l9_106),Tweak_N125Layout,Tweak_N125GetStereoViewIndex());
vec4 l9_110=texture(Tweak_N125,l9_109.xy,0.0);
vec4 l9_111;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N125)
{
l9_111=mix(Tweak_N125BorderColor,l9_110,vec4(l9_108));
}
#else
{
l9_111=l9_110;
...
#endif
float l9_112=(Port_Value_N002+0.001)-0.001;
float l9_113=distance(l9_0,Port_Input1_N000);
float l9_114=Port_Input0_N010-(1.0-width);
float l9_115=(((activeHover-Port_RangeMinA_N009)/((Port_RangeMaxA_N009-Port_RangeMinA_N009)+1e-06))*(l9_114-Port_RangeMinB_N009))+Port_RangeMinB_N009;
float l9_116;
if (l9_114>Port_RangeMinB_N009)
{
l9_116=clamp(l9_115,Port_RangeMinB_N009,l9_114);
}
else
{
l9_116=clamp(l9_115,l9_114,Port_RangeMinB_N009);
}
float l9_117=l9_116+distance(Port_center_N006,vec2(0.5));
float l9_118=mix(l9_116,l9_117,l9_116);
vec2 l9_119=l9_0*vec2(1.0);
float l9_120=mix(animationOff,animationOff+distance(Port_center_N012,vec2(0.5)),animationOff);
float l9_121=(((smoothstep(Port_Input0_N152,Port_Input1_N152,l9_61)*smoothstep(Port_Input0_N186,Port_Input1_N186,l9_63.y))*smoothstep(l9_112,((Port_Value_N003+0.001)-0.001)+l9_112,l9_113))*smoothstep(l9_118,l9_118-Port_feather_N006,distance(l9_119,Port_center_N006*vec2(1.0))))*(1.0-smoothstep(l9_120,l9_120-Port_feather_N012,distance(l9_119,Port_center_N012*vec2(1.0))));
vec4 l9_122=vec4(customColor.x,customColor.y,customColor.z,vec4(0.0).w);
l9_122.w=l9_121;
#if (sc_BlendMode_AlphaTest)
{
if (l9_121<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_121<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0Internal(max(l9_123,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_125;
...
{
l9_127=clamp(l9_121*2.0,0.0,1.0);
}
#else
{
float l9_128;
...
{
l9_128=clamp(dot(l9_122.xyz,vec3(l9_121)),0.0,1.0);
}
#else
{
float l9_129;
...
{
l9_130=(1.0-dot(l9_122.xyz,vec3(0.33333001)))*l9_121;
}
#else
{
float l9_131;
...
{
l9_131=(1.0-clamp(dot(l9_122.xyz,vec3(1.0)),0.0,1.0))*l9_121;
}
#else
{
float l9_132;
...
{
l9_132=clamp(dot(l9_122.xyz,vec3(1.0)),0.0,1.0)*l9_121;
}
#else
{
float l9_133;
#if (sc_BlendMode_Add)
{
l9_133=clamp(dot(l9_122.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_134;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_134=clamp(dot(l9_122.xyz,vec3(1.0)),0.0,1.0)*l9_121;
}
#else
{
float l9_135;
...
{
l9_135=dot(l9_122.xyz,vec3(0.33333001))*l9_121;
}
#else
{
float l9_136;
#if (sc_BlendMode_Min)
{
l9_136=1.0-clamp(dot(l9_122.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_137;
#if (sc_BlendMode_Max)
{
l9_137=clamp(dot(l9_122.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_137=1.0;
...
#endif
l9_125=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_122.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_126);
}
#else
{
vec4 l9_138;
...
#if (sc_FramebufferFetch)
{
vec4 l9_141=sc_readFragData0_Platform();
vec4 l9_142;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_143=l9_141;
l9_143.x=l9_141.x+_sc_framebufferFetchMarker;
l9_142=l9_143;
}
#else
{
...
{
l9_145=1-sc_GetStereoViewIndex();
}
#else
{
l9_145=sc_GetStereoViewIndex();
}
#endif
vec4 l9_146;
#if (sc_ScreenTextureLayout==2)
{
l9_146=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_144,sc_ScreenTextureLayout,l9_145),0.0);
}
#else
{
l9_146=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_144,sc_ScreenTextureLayout,l9_145).xy,0.0);
}
#endif
l9_140=l9_146;
}
...
{
vec4 l9_148=l9_140;
l9_148.x=l9_140.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_147=l9_148;
}
#else
{
...
#endif
vec3 l9_149=mix(l9_147.xyz,definedBlend(l9_147.xyz,l9_122.xyz).xyz,vec3(l9_121));
vec4 l9_150=vec4(l9_149.x,l9_149.y,l9_149.z,vec4(0.0).w);
l9_150.w=1.0;
l9_139=l9_150;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_151=vec4(mix(vec3(1.0),l9_122.xyz,vec3(l9_121)),l9_121);
}
#else
{
vec4 l9_152;
...
#endif
l9_152=vec4(l9_122.xyz*l9_153,l9_153);
}
#else
{
l9_152=l9_122;
...
{
l9_156=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_156=vec4(0.0);
...
vec4 l9_158=outputMotionVectorsIfNeeded(varPos,max(l9_157,vec4(0.0)));
