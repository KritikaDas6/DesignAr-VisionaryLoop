...
//sampler sampler texture_mapSmpSC 0:29
...
//texture texture2D texture_map 0:18:0:29
...
//texture texture2DArray texture_mapArrSC 0:36:0:29
...
//spec_const bool texture_mapHasSwappedViews 78 0
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 79 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_texture_map 80 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 81 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_texture_map 82 -1
...
//spec_const int texture_mapLayout 92 0
//SG_REFLECTION_END
...
float l9_5=clamp(mod((sc_Time.x*Port_Multiplier_N039)+(l9_1.x*Port_Input1_N041),Port_Input1_N043),0.0,1.0);
vec4 l9_6;
if (l9_5<Port_Position1_N038)
{
l9_6=mix(Port_Value0_N038,Port_Value1_N038,vec4(clamp(l9_5/Port_Position1_N038,0.0,1.0)));
}
else
{
l9_6=mix(Port_Value1_N038,Port_Value2_N038,vec4(clamp((l9_5-Port_Position1_N038)/(1.0-Port_Position1_N038),0.0,1.0)));
}
...
vec2 l9_12=l9_2-Port_Center_N032;
vec2 l9_13=(((l9_12*Port_Scale_N032)+Port_Center_N032)+vec2(l9_1.x*Port_Input1_N034))+(Port_Direction_N037*(sc_Time.x*(Tweak_N44*Port_Input1_N046)));
vec4 l9_14;
#if (texture_mapLayout==2)
{
bool l9_15=(int(SC_USE_CLAMP_TO_BORDER_texture_map)!=0)&&(!(int(SC_USE_UV_MIN_MAX_texture_map)!=0));
float l9_16=l9_13.x;
sc_SoftwareWrapEarly(l9_16,ivec2(SC_SOFTWARE_WRAP_MODE_U_texture_map,SC_SOFTWARE_WRAP_MODE_V_texture_map).x);
float l9_17=l9_16;
float l9_18=l9_13.y;
sc_SoftwareWrapEarly(l9_18,ivec2(SC_SOFTWARE_WRAP_MODE_U_texture_map,SC_SOFTWARE_WRAP_MODE_V_texture_map).y);
float l9_19=l9_18;
vec2 l9_20;
float l9_21;
...
{
l9_22=ivec2(SC_SOFTWARE_WRAP_MODE_U_texture_map,SC_SOFTWARE_WRAP_MODE_V_texture_map).x==3;
}
#else
{
...
float l9_23=l9_17;
float l9_24=1.0;
sc_ClampUV(l9_23,texture_mapUvMinMax.x,texture_mapUvMinMax.z,l9_22,l9_24);
float l9_25=l9_23;
float l9_26=l9_24;
bool l9_27;
#if (SC_USE_CLAMP_TO_BORDER_texture_map)
{
l9_27=ivec2(SC_SOFTWARE_WRAP_MODE_U_texture_map,SC_SOFTWARE_WRAP_MODE_V_texture_map).y==3;
}
#else
{
l9_27=(int(SC_USE_CLAMP_TO_BORDER_texture_map)!=0);
}
#endif
float l9_28=l9_19;
float l9_29=l9_26;
sc_ClampUV(l9_28,texture_mapUvMinMax.y,texture_mapUvMinMax.w,l9_27,l9_29);
l9_21=l9_29;
...
#endif
vec2 l9_30=sc_TransformUV(l9_20,(int(SC_USE_UV_TRANSFORM_texture_map)!=0),texture_mapTransform);
float l9_31=l9_30.x;
float l9_32=l9_21;
sc_SoftwareWrapLate(l9_31,ivec2(SC_SOFTWARE_WRAP_MODE_U_texture_map,SC_SOFTWARE_WRAP_MODE_V_texture_map).x,l9_15,l9_32);
float l9_33=l9_30.y;
float l9_34=l9_32;
sc_SoftwareWrapLate(l9_33,ivec2(SC_SOFTWARE_WRAP_MODE_U_texture_map,SC_SOFTWARE_WRAP_MODE_V_texture_map).y,l9_15,l9_34);
float l9_35=l9_34;
vec3 l9_36=sc_SamplingCoordsViewToGlobal(vec2(l9_31,l9_33),texture_mapLayout,texture_mapGetStereoViewIndex());
vec4 l9_37=texture(texture_mapArrSC,l9_36,0.0);
vec4 l9_38;
#if (SC_USE_CLAMP_TO_BORDER_texture_map)
{
l9_38=mix(texture_mapBorderColor,l9_37,vec4(l9_35));
}
#else
{
l9_38=l9_37;
...
#else
{
bool l9_39=(int(SC_USE_CLAMP_TO_BORDER_texture_map)!=0)&&(!(int(SC_USE_UV_MIN_MAX_texture_map)!=0));
float l9_40=l9_13.x;
sc_SoftwareWrapEarly(l9_40,ivec2(SC_SOFTWARE_WRAP_MODE_U_texture_map,SC_SOFTWARE_WRAP_MODE_V_texture_map).x);
float l9_41=l9_40;
float l9_42=l9_13.y;
sc_SoftwareWrapEarly(l9_42,ivec2(SC_SOFTWARE_WRAP_MODE_U_texture_map,SC_SOFTWARE_WRAP_MODE_V_texture_map).y);
float l9_43=l9_42;
vec2 l9_44;
float l9_45;
#if (SC_USE_UV_MIN_MAX_texture_map)
...
#if (SC_USE_CLAMP_TO_BORDER_texture_map)
{
l9_46=ivec2(SC_SOFTWARE_WRAP_MODE_U_texture_map,SC_SOFTWARE_WRAP_MODE_V_texture_map).x==3;
}
#else
{
l9_46=(int(SC_USE_CLAMP_TO_BORDER_texture_map)!=0);
}
#endif
float l9_47=l9_41;
float l9_48=1.0;
sc_ClampUV(l9_47,texture_mapUvMinMax.x,texture_mapUvMinMax.z,l9_46,l9_48);
float l9_49=l9_47;
float l9_50=l9_48;
bool l9_51;
#if (SC_USE_CLAMP_TO_BORDER_texture_map)
{
l9_51=ivec2(SC_SOFTWARE_WRAP_MODE_U_texture_map,SC_SOFTWARE_WRAP_MODE_V_texture_map).y==3;
}
#else
{
l9_51=(int(SC_USE_CLAMP_TO_BORDER_texture_map)!=0);
}
#endif
float l9_52=l9_43;
float l9_53=l9_50;
sc_ClampUV(l9_52,texture_mapUvMinMax.y,texture_mapUvMinMax.w,l9_51,l9_53);
l9_45=l9_53;
...
#endif
vec2 l9_54=sc_TransformUV(l9_44,(int(SC_USE_UV_TRANSFORM_texture_map)!=0),texture_mapTransform);
float l9_55=l9_54.x;
float l9_56=l9_45;
sc_SoftwareWrapLate(l9_55,ivec2(SC_SOFTWARE_WRAP_MODE_U_texture_map,SC_SOFTWARE_WRAP_MODE_V_texture_map).x,l9_39,l9_56);
float l9_57=l9_54.y;
float l9_58=l9_56;
sc_SoftwareWrapLate(l9_57,ivec2(SC_SOFTWARE_WRAP_MODE_U_texture_map,SC_SOFTWARE_WRAP_MODE_V_texture_map).y,l9_39,l9_58);
float l9_59=l9_58;
vec3 l9_60=sc_SamplingCoordsViewToGlobal(vec2(l9_55,l9_57),texture_mapLayout,texture_mapGetStereoViewIndex());
vec4 l9_61=texture(texture_map,l9_60.xy,0.0);
vec4 l9_62;
#if (SC_USE_CLAMP_TO_BORDER_texture_map)
{
l9_62=mix(texture_mapBorderColor,l9_61,vec4(l9_59));
}
#else
{
l9_62=l9_61;
...
#endif
vec4 l9_63=vec4(1.0)-l9_14;
float l9_64=mix(((vec4((1.0-max(smoothstep(Port_Input0_N000,Port_Input1_N000,l9_2.x),1.0-smoothstep(Port_Input0_N003,Port_Input1_N003,l9_2.x)))*(1.0-smoothstep(Port_Input0_N014,Port_Input1_N014,abs(l9_2.y-Port_Input1_N013))))*l9_63)*vec4(smoothstep(Port_Input0_N045,Port_Input1_N045,Tweak_N44))).x,Port_Input1_N047,float(l9_3.y<black_height));
vec4 l9_65=vec4(l9_6.x,l9_6.y,l9_6.z,vec4(0.0).w);
l9_65.w=l9_64;
...
{
l9_71=clamp(dot(l9_65.xyz,vec3(l9_64)),0.0,1.0);
}
#else
{
float l9_72;
...
{
l9_73=(1.0-dot(l9_65.xyz,vec3(0.33333001)))*l9_64;
}
#else
{
float l9_74;
...
{
l9_74=(1.0-clamp(dot(l9_65.xyz,vec3(1.0)),0.0,1.0))*l9_64;
}
#else
{
float l9_75;
...
{
l9_75=clamp(dot(l9_65.xyz,vec3(1.0)),0.0,1.0)*l9_64;
}
#else
{
float l9_76;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_77=clamp(dot(l9_65.xyz,vec3(1.0)),0.0,1.0)*l9_64;
}
#else
{
float l9_78;
...
{
l9_78=dot(l9_65.xyz,vec3(0.33333001))*l9_64;
}
#else
{
float l9_79;
...
{
l9_89=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_87,sc_ScreenTextureLayout,l9_88),0.0);
}
#else
{
l9_89=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_87,sc_ScreenTextureLayout,l9_88).xy,0.0);
}
#endif
l9_83=l9_89;
}
...
{
vec4 l9_91=l9_83;
l9_91.x=l9_83.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_90=l9_91;
}
#else
{
...
#endif
vec3 l9_92=mix(l9_90.xyz,definedBlend(l9_90.xyz,l9_65.xyz).xyz,vec3(l9_64));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_94=vec4(mix(vec3(1.0),l9_65.xyz,vec3(l9_64)),l9_64);
}
#else
{
vec4 l9_95;
...
#endif
l9_95=vec4(l9_65.xyz*l9_96,l9_96);
}
#else
{
l9_95=l9_65;
