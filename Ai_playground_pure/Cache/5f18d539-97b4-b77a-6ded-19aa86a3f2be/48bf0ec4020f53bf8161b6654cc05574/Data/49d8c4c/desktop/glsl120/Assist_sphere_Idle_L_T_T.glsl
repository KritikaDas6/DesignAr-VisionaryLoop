...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N55 87 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N66 88 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N67 89 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 90 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N55 91 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N66 92 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N67 93 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 94 -1
//spec_const int Tweak_N55Layout 95 0
//spec_const int Tweak_N66Layout 96 0
//spec_const int Tweak_N67Layout 97 0
...
float l9_29=floor(float(idleTalkThinking));
vec4 l9_30;
if (l9_29==0.0)
{
float l9_31=((Port_TimeA_N053+Port_TimeTransition_N053)+Port_TimeB_N053)+9.9999997e-05;
l9_30=vec4(mix(Port_ValueA_N053,Port_ValueB_N053,smoothstep(Port_TimeA_N053/l9_31,1.0-(Port_TimeB_N053/l9_31),abs((mod((sc_Time.x/l9_31)+Port_TimeBias_N053,1.0)*2.0)-1.0))));
}
else
{
vec4 l9_32;
if (l9_29==1.0)
{
float l9_33=((Port_TimeA_N063+Port_TimeTransition_N063)+Port_TimeB_N063)+9.9999997e-05;
l9_32=vec4(mix(Port_ValueA_N063,Port_ValueB_N063,smoothstep(Port_TimeA_N063/l9_33,1.0-(Port_TimeB_N063/l9_33),abs((mod((sc_Time.x/l9_33)+(((((floor(((snoise(vec2(floor(fract(sc_Time.x*Port_Multiplier_N001)*10000.0)*9.9999997e-05)*(Port_Scale_N047*0.5))*0.5)+0.5)*10000.0)*9.9999997e-05)-Port_RangeMinA_N048)/((Port_RangeMaxA_N048-Port_RangeMinA_N048)+1e-06))*(Port_RangeMaxB_N048-Port_RangeMinB_N048))+Port_RangeMinB_N048),1.0)*2.0)-1.0))));
}
else
{
vec4 l9_34;
if (l9_29==2.0)
{
l9_34=Port_Value2_N061;
}
else
{
l9_34=Port_Default_N061;
}
l9_32=l9_34;
}
l9_30=l9_32;
...
l9_37=varTangent.xyz;
l9_36=l9_28;
l9_35=(sc_ModelMatrix*vec4((sc_ModelMatrixInverse*vec4(varPos,1.0)).xyz*l9_30.xyz,1.0)).xyz;
}
varPos=l9_35;
...
#if (sc_RenderingSpace==3)
{
l9_39=sc_ProjectionMatrixInverseArray[sc_GetStereoViewIndex()]*l9_15;
}
#else
{
vec4 l9_40;
#if (sc_RenderingSpace==2)
{
l9_40=sc_ViewMatrixArray[sc_GetStereoViewIndex()]*l9_15;
}
#else
{
vec4 l9_41;
#if (sc_RenderingSpace==1)
{
l9_41=sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_15;
}
#else
{
l9_41=l9_15;
...
#if (sc_RenderingSpace==4)
{
l9_43=(sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_15)*vec4(1.0/sc_Camera.aspect,1.0,1.0,1.0);
}
#else
{
vec4 l9_44;
...
#if (sc_TAAEnabled)
{
vec2 l9_52=l9_48.xy+(sc_TAAJitterOffset*l9_48.w);
l9_51=vec4(l9_52.x,l9_52.y,l9_48.z,l9_48.w);
}
#else
{
l9_51=l9_48;
...
{
vec4 l9_54=l9_51;
l9_54.x=l9_51.x+(sc_UniformConstants.x*float(sc_ShaderCacheConstant));
l9_53=l9_54;
}
#else
{
...
{
float l9_55=dot(l9_53,sc_StereoClipPlanes[sc_StereoViewID]);
...
ssGlobals l9_4=ssGlobals(sc_Time.x,sc_Time.y,0.0,l9_0,varPos,l9_1,l9_2,l9_3,varPackedTex.xy);
float l9_5=floor(float(colorSwitchFrom));
vec4 l9_6;
if (l9_5==0.0)
{
vec3 l9_7=(reflect(-l9_0,l9_1)*Port_Input1_N111)+Port_Input1_N112;
bool l9_8=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N66)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N66)!=0));
float l9_9=l9_7.x;
sc_SoftwareWrapEarly(l9_9,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N66,SC_SOFTWARE_WRAP_MODE_V_Tweak_N66).x);
float l9_10=l9_9;
float l9_11=l9_7.y;
sc_SoftwareWrapEarly(l9_11,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N66,SC_SOFTWARE_WRAP_MODE_V_Tweak_N66).y);
float l9_12=l9_11;
vec2 l9_13;
float l9_14;
...
{
l9_15=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N66,SC_SOFTWARE_WRAP_MODE_V_Tweak_N66).x==3;
}
#else
{
l9_15=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N66)!=0);
}
#endif
float l9_16=l9_10;
float l9_17=1.0;
sc_ClampUV(l9_16,Tweak_N66UvMinMax.x,Tweak_N66UvMinMax.z,l9_15,l9_17);
float l9_18=l9_16;
float l9_19=l9_17;
bool l9_20;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N66)
{
l9_20=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N66,SC_SOFTWARE_WRAP_MODE_V_Tweak_N66).y==3;
}
#else
{
l9_20=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N66)!=0);
}
#endif
float l9_21=l9_12;
float l9_22=l9_19;
sc_ClampUV(l9_21,Tweak_N66UvMinMax.y,Tweak_N66UvMinMax.w,l9_20,l9_22);
l9_14=l9_22;
...
#endif
vec2 l9_23=sc_TransformUV(l9_13,(int(SC_USE_UV_TRANSFORM_Tweak_N66)!=0),Tweak_N66Transform);
float l9_24=l9_23.x;
float l9_25=l9_14;
sc_SoftwareWrapLate(l9_24,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N66,SC_SOFTWARE_WRAP_MODE_V_Tweak_N66).x,l9_8,l9_25);
float l9_26=l9_23.y;
float l9_27=l9_25;
sc_SoftwareWrapLate(l9_26,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N66,SC_SOFTWARE_WRAP_MODE_V_Tweak_N66).y,l9_8,l9_27);
float l9_28=l9_27;
vec3 l9_29=sc_SamplingCoordsViewToGlobal(vec2(l9_24,l9_26),Tweak_N66Layout,Tweak_N66GetStereoViewIndex());
vec4 l9_30=texture2D(Tweak_N66,l9_29.xy,0.0);
vec4 l9_31;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N66)
{
l9_31=mix(Tweak_N66BorderColor,l9_30,vec4(l9_28));
}
#else
{
l9_31=l9_30;
...
{
vec2 l9_33;
Node5_Rotate_Coords(((reflect(-l9_0,l9_1)*Port_Input1_N111)+Port_Input1_N112).xy,sc_Time.x*Port_Multiplier_N006,Port_Center_N005,l9_33,l9_4);
bool l9_34=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N67)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N67)!=0));
float l9_35=l9_33.x;
sc_SoftwareWrapEarly(l9_35,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N67,SC_SOFTWARE_WRAP_MODE_V_Tweak_N67).x);
float l9_36=l9_35;
float l9_37=l9_33.y;
sc_SoftwareWrapEarly(l9_37,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N67,SC_SOFTWARE_WRAP_MODE_V_Tweak_N67).y);
float l9_38=l9_37;
vec2 l9_39;
float l9_40;
...
{
l9_41=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N67,SC_SOFTWARE_WRAP_MODE_V_Tweak_N67).x==3;
}
#else
{
l9_41=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N67)!=0);
}
#endif
float l9_42=l9_36;
float l9_43=1.0;
sc_ClampUV(l9_42,Tweak_N67UvMinMax.x,Tweak_N67UvMinMax.z,l9_41,l9_43);
float l9_44=l9_42;
float l9_45=l9_43;
bool l9_46;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N67)
{
l9_46=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N67,SC_SOFTWARE_WRAP_MODE_V_Tweak_N67).y==3;
}
#else
{
l9_46=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N67)!=0);
}
#endif
float l9_47=l9_38;
float l9_48=l9_45;
sc_ClampUV(l9_47,Tweak_N67UvMinMax.y,Tweak_N67UvMinMax.w,l9_46,l9_48);
l9_40=l9_48;
...
#endif
vec2 l9_49=sc_TransformUV(l9_39,(int(SC_USE_UV_TRANSFORM_Tweak_N67)!=0),Tweak_N67Transform);
float l9_50=l9_49.x;
float l9_51=l9_40;
sc_SoftwareWrapLate(l9_50,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N67,SC_SOFTWARE_WRAP_MODE_V_Tweak_N67).x,l9_34,l9_51);
float l9_52=l9_49.y;
float l9_53=l9_51;
sc_SoftwareWrapLate(l9_52,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N67,SC_SOFTWARE_WRAP_MODE_V_Tweak_N67).y,l9_34,l9_53);
float l9_54=l9_53;
vec3 l9_55=sc_SamplingCoordsViewToGlobal(vec2(l9_50,l9_52),Tweak_N67Layout,Tweak_N67GetStereoViewIndex());
vec4 l9_56=texture2D(Tweak_N67,l9_55.xy,0.0);
vec4 l9_57;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N67)
{
l9_57=mix(Tweak_N67BorderColor,l9_56,vec4(l9_54));
}
#else
{
l9_57=l9_56;
...
if (l9_5==2.0)
{
vec3 l9_59=(reflect(-l9_0,l9_1)*Port_Input1_N111)+Port_Input1_N112;
bool l9_60=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N55)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N55)!=0));
float l9_61=l9_59.x;
sc_SoftwareWrapEarly(l9_61,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N55,SC_SOFTWARE_WRAP_MODE_V_Tweak_N55).x);
float l9_62=l9_61;
float l9_63=l9_59.y;
sc_SoftwareWrapEarly(l9_63,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N55,SC_SOFTWARE_WRAP_MODE_V_Tweak_N55).y);
float l9_64=l9_63;
vec2 l9_65;
float l9_66;
...
{
l9_67=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N55,SC_SOFTWARE_WRAP_MODE_V_Tweak_N55).x==3;
}
#else
{
l9_67=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N55)!=0);
}
#endif
float l9_68=l9_62;
float l9_69=1.0;
sc_ClampUV(l9_68,Tweak_N55UvMinMax.x,Tweak_N55UvMinMax.z,l9_67,l9_69);
float l9_70=l9_68;
float l9_71=l9_69;
bool l9_72;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N55)
{
l9_72=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N55,SC_SOFTWARE_WRAP_MODE_V_Tweak_N55).y==3;
}
#else
{
l9_72=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N55)!=0);
}
#endif
float l9_73=l9_64;
float l9_74=l9_71;
sc_ClampUV(l9_73,Tweak_N55UvMinMax.y,Tweak_N55UvMinMax.w,l9_72,l9_74);
l9_66=l9_74;
...
#endif
vec2 l9_75=sc_TransformUV(l9_65,(int(SC_USE_UV_TRANSFORM_Tweak_N55)!=0),Tweak_N55Transform);
float l9_76=l9_75.x;
float l9_77=l9_66;
sc_SoftwareWrapLate(l9_76,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N55,SC_SOFTWARE_WRAP_MODE_V_Tweak_N55).x,l9_60,l9_77);
float l9_78=l9_75.y;
float l9_79=l9_77;
sc_SoftwareWrapLate(l9_78,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N55,SC_SOFTWARE_WRAP_MODE_V_Tweak_N55).y,l9_60,l9_79);
float l9_80=l9_79;
vec3 l9_81=sc_SamplingCoordsViewToGlobal(vec2(l9_76,l9_78),Tweak_N55Layout,Tweak_N55GetStereoViewIndex());
vec4 l9_82=texture2D(Tweak_N55,l9_81.xy,0.0);
vec4 l9_83;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N55)
{
l9_83=mix(Tweak_N55BorderColor,l9_82,vec4(l9_80));
}
#else
{
l9_83=l9_82;
...
{
l9_58=Port_Default_N007;
}
l9_32=l9_58;
}
l9_6=l9_32;
}
float l9_84=floor(float(colorSwitchTo));
vec4 l9_85;
if (l9_84==0.0)
{
vec3 l9_86=(reflect(-l9_0,l9_1)*Port_Input1_N111)+Port_Input1_N112;
bool l9_87=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N66)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N66)!=0));
float l9_88=l9_86.x;
sc_SoftwareWrapEarly(l9_88,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N66,SC_SOFTWARE_WRAP_MODE_V_Tweak_N66).x);
float l9_89=l9_88;
float l9_90=l9_86.y;
sc_SoftwareWrapEarly(l9_90,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N66,SC_SOFTWARE_WRAP_MODE_V_Tweak_N66).y);
float l9_91=l9_90;
vec2 l9_92;
float l9_93;
#if (SC_USE_UV_MIN_MAX_Tweak_N66)
...
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N66)
{
l9_94=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N66,SC_SOFTWARE_WRAP_MODE_V_Tweak_N66).x==3;
}
#else
{
l9_94=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N66)!=0);
}
#endif
float l9_95=l9_89;
float l9_96=1.0;
sc_ClampUV(l9_95,Tweak_N66UvMinMax.x,Tweak_N66UvMinMax.z,l9_94,l9_96);
float l9_97=l9_95;
float l9_98=l9_96;
bool l9_99;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N66)
{
l9_99=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N66,SC_SOFTWARE_WRAP_MODE_V_Tweak_N66).y==3;
}
#else
{
l9_99=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N66)!=0);
}
#endif
float l9_100=l9_91;
float l9_101=l9_98;
sc_ClampUV(l9_100,Tweak_N66UvMinMax.y,Tweak_N66UvMinMax.w,l9_99,l9_101);
l9_93=l9_101;
...
#endif
vec2 l9_102=sc_TransformUV(l9_92,(int(SC_USE_UV_TRANSFORM_Tweak_N66)!=0),Tweak_N66Transform);
float l9_103=l9_102.x;
float l9_104=l9_93;
sc_SoftwareWrapLate(l9_103,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N66,SC_SOFTWARE_WRAP_MODE_V_Tweak_N66).x,l9_87,l9_104);
float l9_105=l9_102.y;
float l9_106=l9_104;
sc_SoftwareWrapLate(l9_105,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N66,SC_SOFTWARE_WRAP_MODE_V_Tweak_N66).y,l9_87,l9_106);
float l9_107=l9_106;
vec3 l9_108=sc_SamplingCoordsViewToGlobal(vec2(l9_103,l9_105),Tweak_N66Layout,Tweak_N66GetStereoViewIndex());
vec4 l9_109=texture2D(Tweak_N66,l9_108.xy,0.0);
vec4 l9_110;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N66)
{
l9_110=mix(Tweak_N66BorderColor,l9_109,vec4(l9_107));
}
#else
{
l9_110=l9_109;
...
{
vec2 l9_112;
Node5_Rotate_Coords(((reflect(-l9_0,l9_1)*Port_Input1_N111)+Port_Input1_N112).xy,sc_Time.x*Port_Multiplier_N006,Port_Center_N005,l9_112,l9_4);
bool l9_113=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N67)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N67)!=0));
float l9_114=l9_112.x;
sc_SoftwareWrapEarly(l9_114,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N67,SC_SOFTWARE_WRAP_MODE_V_Tweak_N67).x);
float l9_115=l9_114;
float l9_116=l9_112.y;
sc_SoftwareWrapEarly(l9_116,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N67,SC_SOFTWARE_WRAP_MODE_V_Tweak_N67).y);
float l9_117=l9_116;
vec2 l9_118;
float l9_119;
#if (SC_USE_UV_MIN_MAX_Tweak_N67)
...
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N67)
{
l9_120=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N67,SC_SOFTWARE_WRAP_MODE_V_Tweak_N67).x==3;
}
#else
{
l9_120=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N67)!=0);
}
#endif
float l9_121=l9_115;
float l9_122=1.0;
sc_ClampUV(l9_121,Tweak_N67UvMinMax.x,Tweak_N67UvMinMax.z,l9_120,l9_122);
float l9_123=l9_121;
float l9_124=l9_122;
bool l9_125;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N67)
{
l9_125=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N67,SC_SOFTWARE_WRAP_MODE_V_Tweak_N67).y==3;
}
#else
{
l9_125=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N67)!=0);
}
#endif
float l9_126=l9_117;
float l9_127=l9_124;
sc_ClampUV(l9_126,Tweak_N67UvMinMax.y,Tweak_N67UvMinMax.w,l9_125,l9_127);
l9_119=l9_127;
...
#endif
vec2 l9_128=sc_TransformUV(l9_118,(int(SC_USE_UV_TRANSFORM_Tweak_N67)!=0),Tweak_N67Transform);
float l9_129=l9_128.x;
float l9_130=l9_119;
sc_SoftwareWrapLate(l9_129,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N67,SC_SOFTWARE_WRAP_MODE_V_Tweak_N67).x,l9_113,l9_130);
float l9_131=l9_128.y;
float l9_132=l9_130;
sc_SoftwareWrapLate(l9_131,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N67,SC_SOFTWARE_WRAP_MODE_V_Tweak_N67).y,l9_113,l9_132);
float l9_133=l9_132;
vec3 l9_134=sc_SamplingCoordsViewToGlobal(vec2(l9_129,l9_131),Tweak_N67Layout,Tweak_N67GetStereoViewIndex());
vec4 l9_135=texture2D(Tweak_N67,l9_134.xy,0.0);
vec4 l9_136;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N67)
{
l9_136=mix(Tweak_N67BorderColor,l9_135,vec4(l9_133));
}
#else
{
l9_136=l9_135;
...
if (l9_84==2.0)
{
vec3 l9_138=(reflect(-l9_0,l9_1)*Port_Input1_N111)+Port_Input1_N112;
bool l9_139=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N55)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N55)!=0));
float l9_140=l9_138.x;
sc_SoftwareWrapEarly(l9_140,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N55,SC_SOFTWARE_WRAP_MODE_V_Tweak_N55).x);
float l9_141=l9_140;
float l9_142=l9_138.y;
sc_SoftwareWrapEarly(l9_142,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N55,SC_SOFTWARE_WRAP_MODE_V_Tweak_N55).y);
float l9_143=l9_142;
vec2 l9_144;
float l9_145;
#if (SC_USE_UV_MIN_MAX_Tweak_N55)
...
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N55)
{
l9_146=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N55,SC_SOFTWARE_WRAP_MODE_V_Tweak_N55).x==3;
}
#else
{
l9_146=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N55)!=0);
}
#endif
float l9_147=l9_141;
float l9_148=1.0;
sc_ClampUV(l9_147,Tweak_N55UvMinMax.x,Tweak_N55UvMinMax.z,l9_146,l9_148);
float l9_149=l9_147;
float l9_150=l9_148;
bool l9_151;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N55)
{
l9_151=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N55,SC_SOFTWARE_WRAP_MODE_V_Tweak_N55).y==3;
}
#else
{
l9_151=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N55)!=0);
}
#endif
float l9_152=l9_143;
float l9_153=l9_150;
sc_ClampUV(l9_152,Tweak_N55UvMinMax.y,Tweak_N55UvMinMax.w,l9_151,l9_153);
l9_145=l9_153;
...
#endif
vec2 l9_154=sc_TransformUV(l9_144,(int(SC_USE_UV_TRANSFORM_Tweak_N55)!=0),Tweak_N55Transform);
float l9_155=l9_154.x;
float l9_156=l9_145;
sc_SoftwareWrapLate(l9_155,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N55,SC_SOFTWARE_WRAP_MODE_V_Tweak_N55).x,l9_139,l9_156);
float l9_157=l9_154.y;
float l9_158=l9_156;
sc_SoftwareWrapLate(l9_157,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N55,SC_SOFTWARE_WRAP_MODE_V_Tweak_N55).y,l9_139,l9_158);
float l9_159=l9_158;
vec3 l9_160=sc_SamplingCoordsViewToGlobal(vec2(l9_155,l9_157),Tweak_N55Layout,Tweak_N55GetStereoViewIndex());
vec4 l9_161=texture2D(Tweak_N55,l9_160.xy,0.0);
vec4 l9_162;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N55)
{
l9_162=mix(Tweak_N55BorderColor,l9_161,vec4(l9_159));
}
#else
{
l9_162=l9_161;
...
{
l9_137=Port_Default_N008;
}
l9_111=l9_137;
}
l9_85=l9_111;
}
float l9_163=max(pow(1.0-abs(dot(-l9_0,mat3(l9_2,l9_3,l9_1)*Port_Normal_N025)),Port_Exponent_N025),0.0)*Port_Intensity_N025;
float l9_164=((Port_TimeA_N003+Port_TimeTransition_N003)+Port_TimeB_N003)+9.9999997e-05;
vec4 l9_165=mix(l9_6,l9_85,vec4(colorSwitchTransition))+vec4(l9_163*mix(Port_ValueA_N003,Port_ValueB_N003,smoothstep(Port_TimeA_N003/l9_164,1.0-(Port_TimeB_N003/l9_164),abs((mod((sc_Time.x/l9_164)+Port_TimeBias_N003,1.0)*2.0)-1.0))));
vec4 l9_166=vec4(l9_165.x,l9_165.y,l9_165.z,vec4(0.0).w);
l9_166.w=(clamp((((smoothstep(Port_Input0_N058,Port_Input1_N058,varPackedTex.y)*Tweak_N57)+Port_Input1_N045)+l9_163)+0.001,Port_Input1_N046+0.001,Port_Input2_N046+0.001)-0.001)*opacity;
vec4 l9_167=clamp(l9_166+vec4(0.001),Port_Input1_N118+vec4(0.001),Port_Input2_N118+vec4(0.001))-vec4(0.001);
float l9_168=l9_167.w;
#if (sc_BlendMode_AlphaTest)
{
if (l9_168<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_168<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_171=clamp(l9_168*2.0,0.0,1.0);
}
#else
{
float l9_172;
...
{
l9_172=clamp(dot(l9_167.xyz,vec3(l9_168)),0.0,1.0);
}
#else
{
float l9_173;
...
{
l9_174=(1.0-dot(l9_167.xyz,vec3(0.33333001)))*l9_168;
}
#else
{
float l9_175;
...
{
l9_175=(1.0-clamp(dot(l9_167.xyz,vec3(1.0)),0.0,1.0))*l9_168;
}
#else
{
float l9_176;
...
{
l9_176=clamp(dot(l9_167.xyz,vec3(1.0)),0.0,1.0)*l9_168;
}
#else
{
float l9_177;
#if (sc_BlendMode_Add)
{
l9_177=clamp(dot(l9_167.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_178;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_178=clamp(dot(l9_167.xyz,vec3(1.0)),0.0,1.0)*l9_168;
}
#else
{
float l9_179;
...
{
l9_179=dot(l9_167.xyz,vec3(0.33333001))*l9_168;
}
#else
{
float l9_180;
#if (sc_BlendMode_Min)
{
l9_180=1.0-clamp(dot(l9_167.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_181;
#if (sc_BlendMode_Max)
{
l9_181=clamp(dot(l9_167.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_181=1.0;
...
#endif
l9_169=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_167.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_170);
}
#else
{
vec4 l9_182;
...
#if (sc_FramebufferFetch)
{
vec4 l9_185=sc_readFragData0_Platform();
vec4 l9_186;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_187=l9_185;
l9_187.x=l9_185.x+_sc_framebufferFetchMarker;
l9_186=l9_187;
}
#else
{
...
#endif
l9_184=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_188,sc_ScreenTextureLayout,l9_189).xy,0.0);
}
#endif
vec4 l9_190;
...
{
vec4 l9_191=l9_184;
l9_191.x=l9_184.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_190=l9_191;
}
#else
{
...
#endif
vec3 l9_192=mix(l9_190.xyz,definedBlend(l9_190.xyz,l9_167.xyz).xyz,vec3(l9_168));
vec4 l9_193=vec4(l9_192.x,l9_192.y,l9_192.z,vec4(0.0).w);
l9_193.w=1.0;
l9_183=l9_193;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_194=vec4(mix(vec3(1.0),l9_167.xyz,vec3(l9_168)),l9_168);
}
#else
{
vec4 l9_195;
...
#endif
l9_195=vec4(l9_167.xyz*l9_196,l9_196);
}
#else
{
l9_195=l9_167;
...
{
l9_199=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_199=vec4(0.0);
...
vec4 l9_201=outputMotionVectorsIfNeeded(varPos,max(l9_200,vec4(0.0)));
vec4 l9_202=clamp(l9_201,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_203=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_203-0.0039215689)),min(1.0,l9_203+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_204=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_204).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_205=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_204).xy);
float l9_206=packValue(l9_205);
int l9_213=int(l9_202.w*255.0);
float l9_214=packValue(l9_213);
sc_writeFragData0Internal(vec4(packValue(l9_205),packValue(l9_205),packValue(l9_205),packValue(l9_205)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_206,packValue(l9_205),packValue(l9_205),packValue(l9_205)));
sc_writeFragData2(vec4(l9_214,packValue(l9_213),packValue(l9_213),packValue(l9_213)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_217=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_217).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_222==0)
{
l9_225=texture2D(sc_OITAlpha0,l9_217);
l9_224=texture2D(sc_OITDepthLow0,l9_217);
l9_223=texture2D(sc_OITDepthHigh0,l9_217);
}
else
{
l9_225=vec4(0.0);
...
if (l9_222==1)
{
l9_228=texture2D(sc_OITAlpha1,l9_217);
l9_227=texture2D(sc_OITDepthLow1,l9_217);
l9_226=texture2D(sc_OITDepthHigh1,l9_217);
}
else
{
l9_228=l9_225;
...
if (any(notEqual(l9_226,vec4(0.0)))||any(notEqual(l9_227,vec4(0.0))))
{
int l9_229[8]=l9_218;
unpackValues(l9_226.w,l9_222,l9_229);
unpackValues(l9_226.z,l9_222,l9_229);
unpackValues(l9_226.y,l9_222,l9_229);
unpackValues(l9_226.x,l9_222,l9_229);
unpackValues(l9_227.w,l9_222,l9_229);
unpackValues(l9_227.z,l9_222,l9_229);
unpackValues(l9_227.y,l9_222,l9_229);
unpackValues(l9_227.x,l9_222,l9_229);
int l9_238[8]=l9_219;
unpackValues(l9_228.w,l9_222,l9_238);
unpackValues(l9_228.z,l9_222,l9_238);
unpackValues(l9_228.y,l9_222,l9_238);
unpackValues(l9_228.x,l9_222,l9_238);
}
l9_222++;
continue;
}
...
vec4 l9_243=texture2D(sc_OITFilteredDepthBoundsTexture,l9_217);
vec2 l9_244=l9_243.xy;
int l9_245;
#if (sc_SkinBonesCount>0)
{
l9_245=encodeDepth(((1.0-l9_243.x)*1000.0)+getDepthOrderingEpsilon(),l9_244);
}
#else
{
l9_245=0;
...
#endif
int l9_246=encodeDepth(viewSpaceDepth(),l9_244);
vec4 l9_247;
l9_247=l9_202*l9_202.w;
vec4 l9_248;
int l9_249=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_249<8)
{
int l9_250=l9_218[l9_249];
int l9_251=l9_246-l9_245;
bool l9_252=l9_250<l9_251;
bool l9_253;
if (l9_252)
{
l9_253=l9_218[l9_249]>0;
}
else
{
l9_253=l9_252;
...
if (l9_253)
{
vec3 l9_254=l9_247.xyz*(1.0-(float(l9_219[l9_249])/255.0));
l9_248=vec4(l9_254.x,l9_254.y,l9_254.z,l9_247.w);
}
else
{
l9_248=l9_247;
...
sc_writeFragData0Internal(l9_247,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
