...
l9_318.w=(clamp((((smoothstep(Port_Input0_N058,Port_Input1_N058,varPackedTex.y)*Tweak_N57)+Port_Input1_N045)+l9_315)+0.001,Port_Input1_N046+0.001,Port_Input2_N046+0.001)-0.001)*opacity;
...
#if (sc_FramebufferFetch)
{
vec4 l9_337=sc_readFragData0_Platform();
vec4 l9_338;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_339=l9_337;
l9_339.x=l9_337.x+_sc_framebufferFetchMarker;
l9_338=l9_339;
}
#else
{
...
{
l9_341=1-sc_GetStereoViewIndex();
}
#else
{
l9_341=sc_GetStereoViewIndex();
}
#endif
vec4 l9_342;
#if (sc_ScreenTextureLayout==2)
{
l9_342=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_340,sc_ScreenTextureLayout,l9_341),0.0);
}
#else
{
l9_342=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_340,sc_ScreenTextureLayout,l9_341).xy,0.0);
}
#endif
l9_336=l9_342;
}
...
{
vec4 l9_344=l9_336;
l9_344.x=l9_336.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_343=l9_344;
}
#else
{
...
#endif
vec3 l9_345=mix(l9_343.xyz,definedBlend(l9_343.xyz,l9_319.xyz).xyz,vec3(l9_320));
vec4 l9_346=vec4(l9_345.x,l9_345.y,l9_345.z,vec4(0.0).w);
l9_346.w=1.0;
l9_335=l9_346;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_347=vec4(mix(vec3(1.0),l9_319.xyz,vec3(l9_320)),l9_320);
}
#else
{
vec4 l9_348;
...
#endif
l9_348=vec4(l9_319.xyz*l9_349,l9_349);
}
#else
{
l9_348=l9_319;
...
{
l9_352=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_352=vec4(0.0);
...
vec4 l9_354=outputMotionVectorsIfNeeded(varPos,max(l9_353,vec4(0.0)));
vec4 l9_355=clamp(l9_354,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_356=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_356-0.0039215689)),min(1.0,l9_356+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_357=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
...
#endif
int l9_358=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_357).xy);
float l9_359=packValue(l9_358);
int l9_366=int(l9_355.w*255.0);
float l9_367=packValue(l9_366);
sc_writeFragData0Internal(vec4(packValue(l9_358),packValue(l9_358),packValue(l9_358),packValue(l9_358)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_359,packValue(l9_358),packValue(l9_358),packValue(l9_358)));
sc_writeFragData2(vec4(l9_367,packValue(l9_366),packValue(l9_366),packValue(l9_366)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_370=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_370).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_375==0)
{
l9_378=texture(sc_OITAlpha0,l9_370);
l9_377=texture(sc_OITDepthLow0,l9_370);
l9_376=texture(sc_OITDepthHigh0,l9_370);
}
else
{
l9_378=vec4(0.0);
...
if (l9_375==1)
{
l9_381=texture(sc_OITAlpha1,l9_370);
l9_380=texture(sc_OITDepthLow1,l9_370);
l9_379=texture(sc_OITDepthHigh1,l9_370);
}
else
{
l9_381=l9_378;
...
if (any(notEqual(l9_379,vec4(0.0)))||any(notEqual(l9_380,vec4(0.0))))
{
int l9_382[8]=l9_371;
unpackValues(l9_379.w,l9_375,l9_382);
unpackValues(l9_379.z,l9_375,l9_382);
unpackValues(l9_379.y,l9_375,l9_382);
unpackValues(l9_379.x,l9_375,l9_382);
unpackValues(l9_380.w,l9_375,l9_382);
unpackValues(l9_380.z,l9_375,l9_382);
unpackValues(l9_380.y,l9_375,l9_382);
unpackValues(l9_380.x,l9_375,l9_382);
int l9_391[8]=l9_372;
unpackValues(l9_381.w,l9_375,l9_391);
unpackValues(l9_381.z,l9_375,l9_391);
unpackValues(l9_381.y,l9_375,l9_391);
unpackValues(l9_381.x,l9_375,l9_391);
}
l9_375++;
continue;
}
...
vec4 l9_396=texture(sc_OITFilteredDepthBoundsTexture,l9_370);
vec2 l9_397=l9_396.xy;
int l9_398;
#if (sc_SkinBonesCount>0)
{
l9_398=encodeDepth(((1.0-l9_396.x)*1000.0)+getDepthOrderingEpsilon(),l9_397);
}
#else
{
l9_398=0;
...
#endif
int l9_399=encodeDepth(viewSpaceDepth(),l9_397);
vec4 l9_400;
l9_400=l9_355*l9_355.w;
vec4 l9_401;
int l9_402=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_402<8)
{
int l9_403=l9_371[l9_402];
int l9_404=l9_399-l9_398;
bool l9_405=l9_403<l9_404;
bool l9_406;
if (l9_405)
{
l9_406=l9_371[l9_402]>0;
}
else
{
l9_406=l9_405;
...
if (l9_406)
{
vec3 l9_407=l9_400.xyz*(1.0-(float(l9_372[l9_402])/255.0));
l9_401=vec4(l9_407.x,l9_407.y,l9_407.z,l9_400.w);
}
else
{
l9_401=l9_400;
...
sc_writeFragData0Internal(l9_400,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
...
sc_writeFragData0Internal(l9_355,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
{
sc_writeFragData0Internal(l9_354,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif
