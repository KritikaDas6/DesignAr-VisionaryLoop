...
//sampler sampler Tweak_N25SmpSC 0:23
//sampler sampler Tweak_N6SmpSC 0:24
//sampler sampler intensityTextureSmpSC 0:25
//sampler sampler planet_refl_mapSmpSC 0:26
...
//texture texture2D Tweak_N25 0:3:0:23
//texture texture2D Tweak_N6 0:4:0:24
//texture texture2D intensityTexture 0:5:0:25
//texture texture2D planet_refl_map 0:6:0:26
...
//texture texture2DArray Tweak_N25ArrSC 0:36:0:23
//texture texture2DArray Tweak_N6ArrSC 0:37:0:24
//texture texture2DArray intensityTextureArrSC 0:38:0:25
//texture texture2DArray planet_refl_mapArrSC 0:39:0:26
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N25 88 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N6 89 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 90 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_planet_refl_map 91 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N25 92 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N6 93 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 94 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_planet_refl_map 95 -1
//spec_const int Tweak_N25Layout 96 0
//spec_const int Tweak_N6Layout 97 0
//spec_const int intensityTextureLayout 98 0
//spec_const int planet_refl_mapLayout 99 0
...
ssGlobals l9_13=ssGlobals(sc_Time.x,sc_Time.y,0.0,l9_6,l9_5,l9_4,l9_3,l9_2,l9_1,l9_0);
mat3 l9_14=mat3(l9_5,l9_4,l9_6);
vec3 l9_15=-l9_3;
vec3 l9_16=normalize(l9_15);
vec3 l9_17=normalize(cross(l9_16,sc_ViewMatrixInverseArray[sc_GetStereoViewIndex()][1].xyz));
vec3 l9_18=cross(l9_17,l9_16);
vec2 l9_19=((mat3(vec3(l9_17.x,l9_18.x,l9_16.x),vec3(l9_17.y,l9_18.y,l9_16.y),vec3(l9_17.z,l9_18.z,l9_16.z))*normalize(l9_14*Port_Import_N013)).xy*0.5)+vec2(0.5);
vec4 l9_20;
#if (planet_refl_mapLayout==2)
{
bool l9_21=(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0)&&(!(int(SC_USE_UV_MIN_MAX_planet_refl_map)!=0));
float l9_22=l9_19.x;
sc_SoftwareWrapEarly(l9_22,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x);
float l9_23=l9_22;
float l9_24=l9_19.y;
sc_SoftwareWrapEarly(l9_24,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y);
float l9_25=l9_24;
vec2 l9_26;
float l9_27;
...
{
l9_28=ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x==3;
}
#else
{
l9_28=(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0);
}
#endif
float l9_29=l9_23;
float l9_30=1.0;
sc_ClampUV(l9_29,planet_refl_mapUvMinMax.x,planet_refl_mapUvMinMax.z,l9_28,l9_30);
float l9_31=l9_29;
float l9_32=l9_30;
bool l9_33;
#if (SC_USE_CLAMP_TO_BORDER_planet_refl_map)
{
l9_33=ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y==3;
}
#else
{
l9_33=(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0);
}
#endif
float l9_34=l9_25;
float l9_35=l9_32;
sc_ClampUV(l9_34,planet_refl_mapUvMinMax.y,planet_refl_mapUvMinMax.w,l9_33,l9_35);
l9_27=l9_35;
...
#endif
vec2 l9_36=sc_TransformUV(l9_26,(int(SC_USE_UV_TRANSFORM_planet_refl_map)!=0),planet_refl_mapTransform);
float l9_37=l9_36.x;
float l9_38=l9_27;
sc_SoftwareWrapLate(l9_37,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x,l9_21,l9_38);
float l9_39=l9_36.y;
float l9_40=l9_38;
sc_SoftwareWrapLate(l9_39,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y,l9_21,l9_40);
float l9_41=l9_40;
vec3 l9_42=sc_SamplingCoordsViewToGlobal(vec2(l9_37,l9_39),planet_refl_mapLayout,planet_refl_mapGetStereoViewIndex());
vec4 l9_43=texture(planet_refl_mapArrSC,l9_42,0.0);
vec4 l9_44;
#if (SC_USE_CLAMP_TO_BORDER_planet_refl_map)
{
l9_44=mix(planet_refl_mapBorderColor,l9_43,vec4(l9_41));
}
#else
{
l9_44=l9_43;
...
#else
{
bool l9_45=(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0)&&(!(int(SC_USE_UV_MIN_MAX_planet_refl_map)!=0));
float l9_46=l9_19.x;
sc_SoftwareWrapEarly(l9_46,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x);
float l9_47=l9_46;
float l9_48=l9_19.y;
sc_SoftwareWrapEarly(l9_48,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y);
float l9_49=l9_48;
vec2 l9_50;
float l9_51;
#if (SC_USE_UV_MIN_MAX_planet_refl_map)
...
#if (SC_USE_CLAMP_TO_BORDER_planet_refl_map)
{
l9_52=ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x==3;
}
#else
{
l9_52=(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0);
}
#endif
float l9_53=l9_47;
float l9_54=1.0;
sc_ClampUV(l9_53,planet_refl_mapUvMinMax.x,planet_refl_mapUvMinMax.z,l9_52,l9_54);
float l9_55=l9_53;
float l9_56=l9_54;
bool l9_57;
#if (SC_USE_CLAMP_TO_BORDER_planet_refl_map)
{
l9_57=ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y==3;
}
#else
{
l9_57=(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0);
}
#endif
float l9_58=l9_49;
float l9_59=l9_56;
sc_ClampUV(l9_58,planet_refl_mapUvMinMax.y,planet_refl_mapUvMinMax.w,l9_57,l9_59);
l9_51=l9_59;
...
#endif
vec2 l9_60=sc_TransformUV(l9_50,(int(SC_USE_UV_TRANSFORM_planet_refl_map)!=0),planet_refl_mapTransform);
float l9_61=l9_60.x;
float l9_62=l9_51;
sc_SoftwareWrapLate(l9_61,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x,l9_45,l9_62);
float l9_63=l9_60.y;
float l9_64=l9_62;
sc_SoftwareWrapLate(l9_63,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y,l9_45,l9_64);
float l9_65=l9_64;
vec3 l9_66=sc_SamplingCoordsViewToGlobal(vec2(l9_61,l9_63),planet_refl_mapLayout,planet_refl_mapGetStereoViewIndex());
vec4 l9_67=texture(planet_refl_map,l9_66.xy,0.0);
vec4 l9_68;
#if (SC_USE_CLAMP_TO_BORDER_planet_refl_map)
{
l9_68=mix(planet_refl_mapBorderColor,l9_67,vec4(l9_65));
}
#else
{
l9_68=l9_67;
...
#endif
vec4 l9_69=vec4(reflIntensity)*l9_20;
vec4 l9_70;
#if (Tweak_N37)
{
vec2 l9_71;
Node3_Rotate_Coords(l9_1,Port_Rotation_N003,Port_Center_N003,l9_71,l9_13);
vec4 l9_72;
Node0_Gradient(l9_71.x,Tweak_N2,colorRatio,Tweak_N8,Tweak_N9,l9_72,l9_13);
vec4 l9_73=l9_72;
vec2 l9_74=l9_1+Port_Offset_N062;
vec2 l9_75=((l9_74-Port_Center_N060)*vec2(Tweak_N66*Tweak_N64,Tweak_N64))+Port_Center_N060;
vec4 l9_76;
#if (Tweak_N25Layout==2)
{
bool l9_77=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N25)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N25)!=0));
float l9_78=l9_75.x;
sc_SoftwareWrapEarly(l9_78,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N25,SC_SOFTWARE_WRAP_MODE_V_Tweak_N25).x);
float l9_79=l9_78;
float l9_80=l9_75.y;
sc_SoftwareWrapEarly(l9_80,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N25,SC_SOFTWARE_WRAP_MODE_V_Tweak_N25).y);
float l9_81=l9_80;
vec2 l9_82;
float l9_83;
...
{
l9_84=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N25,SC_SOFTWARE_WRAP_MODE_V_Tweak_N25).x==3;
}
#else
{
l9_84=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N25)!=0);
}
#endif
float l9_85=l9_79;
float l9_86=1.0;
sc_ClampUV(l9_85,Tweak_N25UvMinMax.x,Tweak_N25UvMinMax.z,l9_84,l9_86);
float l9_87=l9_85;
float l9_88=l9_86;
bool l9_89;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N25)
{
l9_89=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N25,SC_SOFTWARE_WRAP_MODE_V_Tweak_N25).y==3;
}
#else
{
l9_89=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N25)!=0);
}
#endif
float l9_90=l9_81;
float l9_91=l9_88;
sc_ClampUV(l9_90,Tweak_N25UvMinMax.y,Tweak_N25UvMinMax.w,l9_89,l9_91);
l9_83=l9_91;
...
#endif
vec2 l9_92=sc_TransformUV(l9_82,(int(SC_USE_UV_TRANSFORM_Tweak_N25)!=0),Tweak_N25Transform);
float l9_93=l9_92.x;
float l9_94=l9_83;
sc_SoftwareWrapLate(l9_93,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N25,SC_SOFTWARE_WRAP_MODE_V_Tweak_N25).x,l9_77,l9_94);
float l9_95=l9_92.y;
float l9_96=l9_94;
sc_SoftwareWrapLate(l9_95,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N25,SC_SOFTWARE_WRAP_MODE_V_Tweak_N25).y,l9_77,l9_96);
float l9_97=l9_96;
vec3 l9_98=sc_SamplingCoordsViewToGlobal(vec2(l9_93,l9_95),Tweak_N25Layout,Tweak_N25GetStereoViewIndex());
vec4 l9_99=texture(Tweak_N25ArrSC,l9_98,0.0);
vec4 l9_100;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N25)
{
l9_100=mix(Tweak_N25BorderColor,l9_99,vec4(l9_97));
}
#else
{
l9_100=l9_99;
...
#else
{
bool l9_101=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N25)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N25)!=0));
float l9_102=l9_75.x;
sc_SoftwareWrapEarly(l9_102,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N25,SC_SOFTWARE_WRAP_MODE_V_Tweak_N25).x);
float l9_103=l9_102;
float l9_104=l9_75.y;
sc_SoftwareWrapEarly(l9_104,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N25,SC_SOFTWARE_WRAP_MODE_V_Tweak_N25).y);
float l9_105=l9_104;
vec2 l9_106;
float l9_107;
#if (SC_USE_UV_MIN_MAX_Tweak_N25)
...
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N25)
{
l9_108=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N25,SC_SOFTWARE_WRAP_MODE_V_Tweak_N25).x==3;
}
#else
{
l9_108=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N25)!=0);
}
#endif
float l9_109=l9_103;
float l9_110=1.0;
sc_ClampUV(l9_109,Tweak_N25UvMinMax.x,Tweak_N25UvMinMax.z,l9_108,l9_110);
float l9_111=l9_109;
float l9_112=l9_110;
bool l9_113;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N25)
{
l9_113=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N25,SC_SOFTWARE_WRAP_MODE_V_Tweak_N25).y==3;
}
#else
{
l9_113=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N25)!=0);
}
#endif
float l9_114=l9_105;
float l9_115=l9_112;
sc_ClampUV(l9_114,Tweak_N25UvMinMax.y,Tweak_N25UvMinMax.w,l9_113,l9_115);
l9_107=l9_115;
...
#endif
vec2 l9_116=sc_TransformUV(l9_106,(int(SC_USE_UV_TRANSFORM_Tweak_N25)!=0),Tweak_N25Transform);
float l9_117=l9_116.x;
float l9_118=l9_107;
sc_SoftwareWrapLate(l9_117,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N25,SC_SOFTWARE_WRAP_MODE_V_Tweak_N25).x,l9_101,l9_118);
float l9_119=l9_116.y;
float l9_120=l9_118;
sc_SoftwareWrapLate(l9_119,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N25,SC_SOFTWARE_WRAP_MODE_V_Tweak_N25).y,l9_101,l9_120);
float l9_121=l9_120;
vec3 l9_122=sc_SamplingCoordsViewToGlobal(vec2(l9_117,l9_119),Tweak_N25Layout,Tweak_N25GetStereoViewIndex());
vec4 l9_123=texture(Tweak_N25,l9_122.xy,0.0);
vec4 l9_124;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N25)
{
l9_124=mix(Tweak_N25BorderColor,l9_123,vec4(l9_121));
}
#else
{
l9_124=l9_123;
...
#endif
l9_70=vec4(mix(l9_73.xyz,l9_76.xyz,vec3(l9_76.w)),0.0);
}
#else
{
vec2 l9_125;
Node3_Rotate_Coords(l9_1,Port_Rotation_N003,Port_Center_N003,l9_125,l9_13);
vec4 l9_126;
Node0_Gradient(l9_125.x,Tweak_N2,colorRatio,Tweak_N8,Tweak_N9,l9_126,l9_13);
l9_70=l9_126;
}
#endif
vec4 l9_127=l9_69+l9_70;
vec4 l9_128;
#if (Tweak_N6Layout==2)
{
bool l9_129=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N6)!=0));
float l9_130=l9_0.x;
sc_SoftwareWrapEarly(l9_130,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x);
float l9_131=l9_130;
float l9_132=l9_0.y;
sc_SoftwareWrapEarly(l9_132,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y);
float l9_133=l9_132;
vec2 l9_134;
float l9_135;
...
{
l9_136=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x==3;
}
#else
{
l9_136=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0);
}
#endif
float l9_137=l9_131;
float l9_138=1.0;
sc_ClampUV(l9_137,Tweak_N6UvMinMax.x,Tweak_N6UvMinMax.z,l9_136,l9_138);
float l9_139=l9_137;
float l9_140=l9_138;
bool l9_141;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
l9_141=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y==3;
}
#else
{
l9_141=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0);
}
#endif
float l9_142=l9_133;
float l9_143=l9_140;
sc_ClampUV(l9_142,Tweak_N6UvMinMax.y,Tweak_N6UvMinMax.w,l9_141,l9_143);
l9_135=l9_143;
...
#endif
vec2 l9_144=sc_TransformUV(l9_134,(int(SC_USE_UV_TRANSFORM_Tweak_N6)!=0),Tweak_N6Transform);
float l9_145=l9_144.x;
float l9_146=l9_135;
sc_SoftwareWrapLate(l9_145,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x,l9_129,l9_146);
float l9_147=l9_144.y;
float l9_148=l9_146;
sc_SoftwareWrapLate(l9_147,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y,l9_129,l9_148);
float l9_149=l9_148;
vec3 l9_150=sc_SamplingCoordsViewToGlobal(vec2(l9_145,l9_147),Tweak_N6Layout,Tweak_N6GetStereoViewIndex());
vec4 l9_151=texture(Tweak_N6ArrSC,l9_150,0.0);
vec4 l9_152;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
l9_152=mix(Tweak_N6BorderColor,l9_151,vec4(l9_149));
}
#else
{
l9_152=l9_151;
...
#else
{
bool l9_153=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N6)!=0));
float l9_154=l9_0.x;
sc_SoftwareWrapEarly(l9_154,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x);
float l9_155=l9_154;
float l9_156=l9_0.y;
sc_SoftwareWrapEarly(l9_156,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y);
float l9_157=l9_156;
vec2 l9_158;
float l9_159;
#if (SC_USE_UV_MIN_MAX_Tweak_N6)
...
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
l9_160=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x==3;
}
#else
{
l9_160=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0);
}
#endif
float l9_161=l9_155;
float l9_162=1.0;
sc_ClampUV(l9_161,Tweak_N6UvMinMax.x,Tweak_N6UvMinMax.z,l9_160,l9_162);
float l9_163=l9_161;
float l9_164=l9_162;
bool l9_165;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
l9_165=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y==3;
}
#else
{
l9_165=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0);
}
#endif
float l9_166=l9_157;
float l9_167=l9_164;
sc_ClampUV(l9_166,Tweak_N6UvMinMax.y,Tweak_N6UvMinMax.w,l9_165,l9_167);
l9_159=l9_167;
...
#endif
vec2 l9_168=sc_TransformUV(l9_158,(int(SC_USE_UV_TRANSFORM_Tweak_N6)!=0),Tweak_N6Transform);
float l9_169=l9_168.x;
float l9_170=l9_159;
sc_SoftwareWrapLate(l9_169,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x,l9_153,l9_170);
float l9_171=l9_168.y;
float l9_172=l9_170;
sc_SoftwareWrapLate(l9_171,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y,l9_153,l9_172);
float l9_173=l9_172;
vec3 l9_174=sc_SamplingCoordsViewToGlobal(vec2(l9_169,l9_171),Tweak_N6Layout,Tweak_N6GetStereoViewIndex());
vec4 l9_175=texture(Tweak_N6,l9_174.xy,0.0);
vec4 l9_176;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
l9_176=mix(Tweak_N6BorderColor,l9_175,vec4(l9_173));
}
#else
{
l9_176=l9_175;
...
#endif
vec3 l9_177=l9_127.xyz;
vec3 l9_178=mix(l9_177,(l9_128.xyz*l9_177).xyz,vec3(l9_128.w));
vec4 l9_179=vec4(l9_178.x,l9_178.y,l9_178.z,vec4(0.0).w);
l9_179.w=Port_Value2_N053;
...
#endif
sc_writeFragData0Internal(max(l9_180,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_182;
...
{
l9_184=clamp(Port_Value2_N053*2.0,0.0,1.0);
}
#else
{
float l9_185;
...
{
l9_185=clamp(dot(l9_179.xyz,vec3(Port_Value2_N053)),0.0,1.0);
}
#else
{
float l9_186;
...
{
l9_187=(1.0-dot(l9_179.xyz,vec3(0.33333001)))*Port_Value2_N053;
}
#else
{
float l9_188;
...
{
l9_188=(1.0-clamp(dot(l9_179.xyz,vec3(1.0)),0.0,1.0))*Port_Value2_N053;
}
#else
{
float l9_189;
...
{
l9_189=clamp(dot(l9_179.xyz,vec3(1.0)),0.0,1.0)*Port_Value2_N053;
}
#else
{
float l9_190;
#if (sc_BlendMode_Add)
{
l9_190=clamp(dot(l9_179.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_191;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_191=clamp(dot(l9_179.xyz,vec3(1.0)),0.0,1.0)*Port_Value2_N053;
}
#else
{
float l9_192;
...
{
l9_192=dot(l9_179.xyz,vec3(0.33333001))*Port_Value2_N053;
}
#else
{
float l9_193;
#if (sc_BlendMode_Min)
{
l9_193=1.0-clamp(dot(l9_179.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_194;
#if (sc_BlendMode_Max)
{
l9_194=clamp(dot(l9_179.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_194=1.0;
...
#endif
l9_182=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_179.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_183);
}
#else
{
vec4 l9_195;
...
#if (sc_FramebufferFetch)
{
vec4 l9_198=sc_readFragData0_Platform();
vec4 l9_199;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_200=l9_198;
l9_200.x=l9_198.x+_sc_framebufferFetchMarker;
l9_199=l9_200;
}
#else
{
...
#else
{
vec2 l9_201=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
int l9_202;
#if (sc_ScreenTextureHasSwappedViews)
{
l9_202=1-sc_GetStereoViewIndex();
}
#else
{
l9_202=sc_GetStereoViewIndex();
}
#endif
vec4 l9_203;
#if (sc_ScreenTextureLayout==2)
{
l9_203=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_201,sc_ScreenTextureLayout,l9_202),0.0);
}
#else
{
l9_203=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_201,sc_ScreenTextureLayout,l9_202).xy,0.0);
}
#endif
l9_197=l9_203;
}
...
{
vec4 l9_205=l9_197;
l9_205.x=l9_197.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_204=l9_205;
}
#else
{
...
#endif
vec3 l9_206=mix(l9_204.xyz,definedBlend(l9_204.xyz,l9_179.xyz).xyz,vec3(Port_Value2_N053));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_208=vec4(mix(vec3(1.0),l9_179.xyz,vec3(Port_Value2_N053)),Port_Value2_N053);
}
#else
{
vec4 l9_209;
...
{
l9_210=clamp(Port_Value2_N053,0.0,1.0);
}
#else
{
l9_210=Port_Value2_N053;
}
#endif
l9_209=vec4(l9_179.xyz*l9_210,l9_210);
}
#else
{
l9_209=l9_179;
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_218=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_218).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_219=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_218).xy);
...
#if (sc_OITCompositingPass)
{
vec2 l9_231=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_231).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_236==0)
{
l9_239=texture(sc_OITAlpha0,l9_231);
l9_238=texture(sc_OITDepthLow0,l9_231);
l9_237=texture(sc_OITDepthHigh0,l9_231);
}
else
{
l9_239=vec4(0.0);
...
if (l9_236==1)
{
l9_242=texture(sc_OITAlpha1,l9_231);
l9_241=texture(sc_OITDepthLow1,l9_231);
l9_240=texture(sc_OITDepthHigh1,l9_231);
}
else
{
l9_242=l9_239;
...
vec4 l9_257=texture(sc_OITFilteredDepthBoundsTexture,l9_231);
