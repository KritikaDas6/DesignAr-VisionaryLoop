...
import BaseInteractor from "../../SpectaclesInteractionKit/Core/Interactor/BaseInteractor"
import {
  DragType,
  InteractorInputType,
...
export class SyncInteractor extends BaseInteractor {
  ...
  onAwake() {
    // SyncInteractor doesn't need to set inputType in onAwake
  }
   ...
   */
  updateState(): void {
    // SyncInteractor state is managed externally by SyncInteractionManager
  }
