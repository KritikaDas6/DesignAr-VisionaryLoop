      ...
      let request: GeminiTypes.Models.GenerateContentRequest = {
        ...
        body: {
          ...
          generationConfig: {
            ...
            // Note: Gemini may not support explicit size parameters
            // The model will generate images, but aspect ratio may vary
            // Consider adding "square" or "1:1 aspect ratio" to the prompt if needed
          },
        },
      };
  ...
  private generateWithOpenAI(prompt: string): Promise<Texture> {
    return new Promise((resolve, reject) => {
      let req = {
        ...
        n: 1,
        model: "dall-e-3",
        size: "1024x1024", // Force square images
