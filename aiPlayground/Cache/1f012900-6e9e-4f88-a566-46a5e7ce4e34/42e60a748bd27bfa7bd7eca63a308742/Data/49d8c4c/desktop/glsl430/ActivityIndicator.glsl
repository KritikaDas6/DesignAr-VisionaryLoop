...
varColor=color;
int l9_28=sc_GetLocalInstanceIDInternal(sc_FallbackInstanceID);
float l9_29;
if (sc_GeometryInfo.y>1.0)
{
l9_29=float(sc_GetLocalInstanceIDInternal(sc_FallbackInstanceID))/(sc_GeometryInfo.y-1.0);
}
else
{
l9_29=0.0;
...
float l9_32=float(l9_31);
vec3 l9_33=normalize(Port_RotationAxis_N005);
float l9_34=radians((((l9_32-Port_RangeMinA_N050)/((Port_RangeMaxA_N050-Port_RangeMinA_N050)+1e-06))*((Port_Input0_N067*((((in_out-Port_RangeMinA_N035)/((Port_RangeMaxA_N035-Port_RangeMinA_N035)+1e-06))*(Port_RangeMaxB_N035-Port_RangeMinB_N035))+Port_RangeMinB_N035))-Port_RangeMinB_N050))+Port_RangeMinB_N050);
...
float l9_40=l9_33.y;
float l9_41=l9_39*l9_40;
float l9_42=l9_33.z;
float l9_43=l9_42*l9_35;
float l9_44=l9_37*l9_42;
float l9_45=l9_44*l9_38;
float l9_46=l9_40*l9_35;
float l9_47=l9_37*l9_40;
float l9_48=l9_47*l9_42;
float l9_49=l9_38*l9_35;
float l9_50=Port_Input0_N057*in_out;
vec3 l9_51=(sc_ModelMatrixInverse*vec4(varPos,1.0)).xyz*vec3((((l9_32-Port_RangeMinA_N025)/((Port_RangeMaxA_N025-Port_RangeMinA_N025)+1e-06))*((Port_Input0_N058*in_out)-l9_50))+l9_50);
vec3 l9_52;
vec3 l9_53;
vec3 l9_54;
if (l9_25)
{
l9_54=varTangent.xyz;
l9_53=varNormal;
l9_52=varPos;
}
else
...
l9_54=varTangent.xyz;
l9_53=l9_30;
l9_52=(sc_ModelMatrix*vec4(mat3(vec3((l9_39*l9_38)+l9_36,l9_41-l9_43,l9_45+l9_46),vec3(l9_41+l9_43,(l9_47*l9_40)+l9_36,l9_48-l9_49),vec3(l9_45-l9_46,l9_48+l9_49,(l9_44*l9_42)+l9_36))*(Port_Input0_N022+vec4(l9_51.x,l9_51.y+((((l9_32-Port_RangeMinA_N010)/((Port_RangeMaxA_N010-Port_RangeMinA_N010)+1e-06))*(Port_RangeMaxB_N010-Port_RangeMinB_N010))+Port_RangeMinB_N010),l9_51.z,0.0)).xyz,1.0)).xyz;
}
varPos=l9_52;
varNormal=normalize(l9_53);
vec3 l9_55=normalize(l9_54);
varTangent=vec4(l9_55.x,l9_55.y,l9_55.z,varTangent.w);
...
#if (sc_RenderingSpace==3)
{
l9_56=sc_ProjectionMatrixInverseArray[sc_GetStereoViewIndex()]*l9_15;
}
#else
{
vec4 l9_57;
#if (sc_RenderingSpace==2)
{
l9_57=sc_ViewMatrixArray[sc_GetStereoViewIndex()]*l9_15;
}
#else
{
vec4 l9_58;
#if (sc_RenderingSpace==1)
{
l9_58=sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_15;
}
#else
{
l9_58=l9_15;
...
#if (sc_RenderingSpace==4)
{
l9_60=(sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_15)*vec4(1.0/sc_Camera.aspect,1.0,1.0,1.0);
}
#else
{
vec4 l9_61;
#if (sc_RenderingSpace==2)
{
l9_61=sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(varPos,1.0);
}
#else
{
vec4 l9_62;
#if (sc_RenderingSpace==1)
{
l9_62=sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(varPos,1.0);
}
#else
{
l9_62=vec4(0.0);
...
#endif
vec4 l9_64=sc_ProjectorMatrix*l9_63;
varShadowTex=((l9_64.xy/vec2(l9_64.w))*0.5)+vec2(0.5);
}
#endif
vec4 l9_65;
...
{
vec4 l9_67=l9_59;
l9_67.z=((log2(max(sc_Camera.clipPlanes.x,1.0+l9_59.w))*(2.0/log2(sc_Camera.clipPlanes.y+1.0)))-1.0)*l9_59.w;
l9_66=l9_67;
}
else
{
...
#if (sc_TAAEnabled)
{
vec2 l9_69=l9_65.xy+(sc_TAAJitterOffset*l9_65.w);
l9_68=vec4(l9_69.x,l9_69.y,l9_65.z,l9_65.w);
}
#else
{
l9_68=l9_65;
...
{
vec4 l9_71=l9_68;
l9_71.x=l9_68.x+(sc_UniformConstants.x*float(sc_ShaderCacheConstant));
l9_70=l9_71;
}
#else
{
...
{
float l9_72=dot(l9_70,sc_StereoClipPlanes[sc_StereoViewID]);
#if (sc_StereoRendering_IsClipDistanceEnabled==1)
{
sc_SetClipDistancePlatform(l9_72);
}
#else
{
varClipDistance=l9_72;
}
#endif
}
#endif
gl_Position=l9_70;
Interpolator_gInstanceID=float(l9_28);
Interpolator_gInstanceRatio=l9_29;
}
...
{
l9_75=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_73,sc_ScreenTextureLayout,l9_74),0.0);
}
#else
{
l9_75=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_73,sc_ScreenTextureLayout,l9_74).xy,0.0);
}
#endif
l9_69=l9_75;
}
...
{
vec4 l9_77=l9_69;
l9_77.x=l9_69.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_76=l9_77;
}
#else
{
...
#endif
vec3 l9_78=mix(l9_76.xyz,definedBlend(l9_76.xyz,l9_53.xyz).xyz,vec3(l9_52));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_80=vec4(mix(vec3(1.0),l9_53.xyz,vec3(l9_52)),l9_52);
}
#else
{
vec4 l9_81;
...
#endif
l9_81=vec4(l9_53.xyz*l9_82,l9_82);
}
#else
{
l9_81=l9_53;
...
{
l9_85=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_85=vec4(0.0);
...
vec4 l9_87=outputMotionVectorsIfNeeded(varPos,max(l9_86,vec4(0.0)));
