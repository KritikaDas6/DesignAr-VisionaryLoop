...
//spec_const bool sc_BlendMode_PremultipliedAlphaAuto 41 0
//spec_const bool sc_BlendMode_Screen 42 0
//spec_const bool sc_BlendMode_Software 43 0
//spec_const bool sc_FramebufferFetch 44 0
//spec_const bool sc_GetFramebufferColorInvalidUsageMarker 45 0
//spec_const bool sc_IsEditor 46 0
//spec_const bool sc_MotionVectorsPass 47 0
//spec_const bool sc_RenderAlphaToColor 48 0
//spec_const bool sc_ScreenTextureHasSwappedViews 49 0
//spec_const bool sc_ShaderComplexityAnalyzer 50 0
//spec_const bool sc_UseFramebufferFetchMarker 51 0
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 52 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 53 -1
//spec_const int intensityTextureLayout 54 0
//spec_const int renderTarget0Layout 55 0
//spec_const int renderTarget1Layout 56 0
//spec_const int renderTarget2Layout 57 0
//spec_const int renderTarget3Layout 58 0
//spec_const int sc_DepthBufferMode 59 0
//spec_const int sc_ScreenTextureLayout 60 0
//spec_const int sc_ShaderCacheConstant 61 0
//spec_const int sc_StereoRenderingMode 62 0
//spec_const int sc_StereoRendering_IsClipDistanceEnabled 63 0
//spec_const int sc_StereoViewID 64 0
//SG_REFLECTION_END
...
{
l9_0=textureLod(renderTarget0ArrSC,sc_SamplingCoordsViewToGlobal(uv,renderTarget0Layout,viewIndex),level_);
}
#else
{
l9_0=textureLod(renderTarget0,sc_SamplingCoordsViewToGlobal(uv,renderTarget0Layout,viewIndex).xy,level_);
}
#endif
return l9_0;
}
...
{
l9_0=textureLod(renderTarget1ArrSC,sc_SamplingCoordsViewToGlobal(uv,renderTarget1Layout,viewIndex),level_);
}
#else
{
l9_0=textureLod(renderTarget1,sc_SamplingCoordsViewToGlobal(uv,renderTarget1Layout,viewIndex).xy,level_);
}
#endif
return l9_0;
}
...
{
l9_0=textureLod(renderTarget2ArrSC,sc_SamplingCoordsViewToGlobal(uv,renderTarget2Layout,viewIndex),level_);
}
#else
{
l9_0=textureLod(renderTarget2,sc_SamplingCoordsViewToGlobal(uv,renderTarget2Layout,viewIndex).xy,level_);
}
#endif
return l9_0;
}
...
{
l9_0=textureLod(renderTarget3ArrSC,sc_SamplingCoordsViewToGlobal(uv,renderTarget3Layout,viewIndex),level_);
}
#else
{
l9_0=textureLod(renderTarget3,sc_SamplingCoordsViewToGlobal(uv,renderTarget3Layout,viewIndex).xy,level_);
}
#endif
return l9_0;
}
...
gParticle=ssParticle(gParticle.Position,gParticle.Velocity,gParticle.Color,gParticle.Size,gParticle.Age,gParticle.Life,gParticle.Mass,gParticle.Matrix,false,gParticle.Quaternion,gParticle.SpawnIndex,gParticle.SpawnIndexRemainder,gParticle.NextBurstTime,gParticle.collisionCount_N119,l9_8,fract(abs(((l9_7*0.97637898)+0.151235)+(floor(((((l9_9-l9_8)-0.0)+0.0)+0.40000001)/0.2)*4.32723))),(vec2(ivec2(l9_0%400,l9_0/400))+vec2(1.0))/vec2(399.0),float(((l9_0*((l9_0*1471343)+101146501))+1559861749)&2147483647)*4.6566129e-10,l9_0,l9_2,l9_3,(40*(l9_1+1))-1,(l9_5+0.5)/40.0,l9_7,l9_3/39.0,l9_4,(l9_6+vec2(0.5))/vec2(40.0,1.0),l9_6/vec2(39.0,1.0),vec3(0.0),false,gParticle.CopyId,gParticle.SpawnAmount,gParticle.BurstAmount,gParticle.BurstPeriod);
...
vec4 l9_15=renderTarget0SampleViewIndexLevel(l9_14,renderTarget0GetStereoViewIndex(),0.0);
bool l9_16=dot(abs(l9_15),vec4(1.0))<9.9999997e-06;
bool l9_17;
if (!l9_16)
{
l9_17=!vfxBatchEnable[sc_GetLocalInstanceIDInternal(sc_FallbackInstanceID)/40];
}
else
{
l9_17=l9_16;
...
gParticle.Position.y=(-1000.0)+(((DecodeFloat32(renderTarget1SampleViewIndexLevel(l9_14,renderTarget1GetStereoViewIndex(),0.0),true)-0.0)*l9_18)/l9_19);
gParticle.Position.z=(-1000.0)+(((DecodeFloat32(renderTarget2SampleViewIndexLevel(l9_14,renderTarget2GetStereoViewIndex(),0.0),true)-0.0)*l9_18)/l9_19);
gParticle.Velocity.x=(-1000.0)+(((DecodeFloat32(renderTarget3SampleViewIndexLevel(l9_14,renderTarget3GetStereoViewIndex(),0.0),true)-0.0)*l9_18)/l9_19);
vec2 l9_20=l9_13+vec2(0.00048828125,0.0);
gParticle.Velocity.y=(-1000.0)+(((DecodeFloat32(renderTarget0SampleViewIndexLevel(l9_20,renderTarget0GetStereoViewIndex(),0.0),true)-0.0)*l9_18)/l9_19);
gParticle.Velocity.z=(-1000.0)+(((DecodeFloat32(renderTarget1SampleViewIndexLevel(l9_20,renderTarget1GetStereoViewIndex(),0.0),true)-0.0)*l9_18)/l9_19);
float l9_21=0.2-0.0;
gParticle.Life=0.0+(((DecodeFloat32(renderTarget2SampleViewIndexLevel(l9_20,renderTarget2GetStereoViewIndex(),0.0),true)-0.0)*l9_21)/l9_19);
gParticle.Age=0.0+(((DecodeFloat32(renderTarget3SampleViewIndexLevel(l9_20,renderTarget3GetStereoViewIndex(),0.0),true)-0.0)*l9_21)/l9_19);
vec2 l9_22=l9_13+vec2(0.0009765625,0.0);
vec4 l9_23=renderTarget0SampleViewIndexLevel(l9_22,renderTarget0GetStereoViewIndex(),0.0);
vec4 l9_24=renderTarget1SampleViewIndexLevel(l9_22,renderTarget1GetStereoViewIndex(),0.0);
vec4 l9_25=renderTarget2SampleViewIndexLevel(l9_22,renderTarget2GetStereoViewIndex(),0.0);
vec4 l9_26=renderTarget3SampleViewIndexLevel(l9_22,renderTarget3GetStereoViewIndex(),0.0);
...
gParticle.collisionCount_N119=0.0+(((DecodeFloat8(renderTarget0SampleViewIndexLevel(l9_31,renderTarget0GetStereoViewIndex(),0.0).x,true)-0.0)*(255.0-0.0))/l9_30);
...
bool l9_1=l9_0>=(40*(vfxNumCopies+1));
bool l9_2;
if (!l9_1)
{
l9_2=vfxBatchEnable[sc_GetLocalInstanceIDInternal(sc_FallbackInstanceID)/40]==false;
}
else
{
l9_2=l9_1;
...
bool l9_3=ssDecodeParticle(l9_0);
if (!l9_3)
{
sc_SetClipPosition(vec4(4334.0,4334.0,4334.0,0.0));
return;
}
float l9_4=gParticle.Size;
bool l9_5=l9_4<9.9999997e-06;
bool l9_6;
if (!l9_5)
{
l9_6=gParticle.Age>=gParticle.Life;
}
else
{
l9_6=l9_5;
...
gParticle.Matrix=quaternionToMatrix(gParticle.Quaternion);
varPos=gParticle.Position+((gParticle.Matrix*position.xyz)*gParticle.Size);
varNormal=gParticle.Matrix*normal;
vec3 l9_7=gParticle.Matrix*tangent.xyz;
varTangent=vec4(l9_7.x,l9_7.y,l9_7.z,varTangent.w);
varTangent.w=tangent.w;
varPackedTex=vec4(texture0,texture1);
vec4 l9_8=sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(varPos,1.0);
vec4 l9_9;
...
float l9_11=l9_8.w;
vec4 l9_12=l9_8;
l9_12.z=((log2(max(sc_Camera.clipPlanes.x,1.0+l9_11))*(2.0/log2(sc_Camera.clipPlanes.y+1.0)))-1.0)*l9_11;
l9_10=l9_12;
}
else
{
...
#endif
sc_SetClipPosition(l9_9);
Interp_Particle_Index=sc_GetLocalInstanceIDInternal(sc_FallbackInstanceID);
...
float l9_6=((((distance(varPos,sc_Camera.position)*Port_Input1_N017)-Port_RangeMinA_N018)/((Port_RangeMaxA_N018-Port_RangeMinA_N018)+1e-06))*(Port_RangeMaxB_N018-Port_RangeMinB_N018))+Port_RangeMinB_N018;
float l9_7;
...
#else
{
vec2 l9_24=gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw;
vec2 l9_25;
#if (sc_StereoRenderingMode==1)
{
vec3 l9_26=vec3(l9_24,0.0);
l9_26.y=((2.0*l9_24.y)+float(sc_GetStereoViewIndex()))-1.0;
l9_25=l9_26.xy;
}
#else
{
...
{
l9_28=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_25,sc_ScreenTextureLayout,l9_27),0.0);
}
#else
{
l9_28=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_25,sc_ScreenTextureLayout,l9_27).xy,0.0);
}
#endif
l9_20=l9_28;
}
...
{
vec4 l9_30=l9_20;
l9_30.x=l9_20.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_29=l9_30;
}
#else
{
...
#endif
vec3 l9_31=mix(l9_29.xyz,definedBlend(l9_29.xyz,l9_17.xyz).xyz,vec3(l9_16.x));
...
{
l9_33=vec4(mix(vec3(1.0),l9_17.xyz,vec3(l9_16.x)),l9_16.x);
}
#else
{
vec4 l9_34;
...
#endif
l9_34=vec4(l9_17.xyz*l9_35,l9_35);
}
#else
{
l9_34=l9_17;
