...
vec2 l9_30=l9_28.xy*dot(l9_26,ringStroke);
vec3 l9_31=vec3(l9_30.x,l9_30.y,l9_28.z);
l9_31.x=l9_30.x+dot(l9_26,ringRadius);
float l9_32=dot(l9_26,arcCenter);
float l9_33=l9_32+(arcSpread*l9_0.x);
float l9_34=cos(l9_33);
float l9_35=sin(l9_33);
vec4 l9_36=sc_ModelMatrix*vec4(dot(l9_31.xy,vec2(l9_34,-l9_35)),dot(l9_31.xy,vec2(l9_35,l9_34)),l9_28.z,1.0);
vec3 l9_37;
vec3 l9_38;
vec3 l9_39;
if (l9_25)
{
l9_39=varTangent.xyz;
l9_38=varNormal;
l9_37=varPos;
}
else
...
l9_39=varTangent.xyz;
l9_38=l9_29;
l9_37=l9_36.xyz/vec3(l9_36.w);
}
varPos=l9_37;
varNormal=normalize(l9_38);
vec3 l9_40=normalize(l9_39);
varTangent=vec4(l9_40.x,l9_40.y,l9_40.z,varTangent.w);
...
#if (sc_RenderingSpace==3)
{
l9_41=sc_ProjectionMatrixInverseArray[sc_GetStereoViewIndex()]*l9_15;
}
#else
{
vec4 l9_42;
#if (sc_RenderingSpace==2)
{
l9_42=sc_ViewMatrixArray[sc_GetStereoViewIndex()]*l9_15;
}
#else
{
vec4 l9_43;
#if (sc_RenderingSpace==1)
{
l9_43=sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_15;
}
#else
{
l9_43=l9_15;
...
#if (sc_RenderingSpace==4)
{
l9_45=(sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_15)*vec4(1.0/sc_Camera.aspect,1.0,1.0,1.0);
}
#else
{
vec4 l9_46;
...
#if (sc_RenderingSpace==1)
{
l9_47=sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(varPos,1.0);
}
#else
{
l9_47=vec4(0.0);
...
#endif
vec4 l9_49=sc_ProjectorMatrix*l9_48;
varShadowTex=((l9_49.xy/vec2(l9_49.w))*0.5)+vec2(0.5);
}
#endif
vec4 l9_50;
...
{
vec4 l9_52=l9_44;
l9_52.z=((log2(max(sc_Camera.clipPlanes.x,1.0+l9_44.w))*(2.0/log2(sc_Camera.clipPlanes.y+1.0)))-1.0)*l9_44.w;
l9_51=l9_52;
}
else
{
...
#if (sc_TAAEnabled)
{
vec2 l9_54=l9_50.xy+(sc_TAAJitterOffset*l9_50.w);
l9_53=vec4(l9_54.x,l9_54.y,l9_50.z,l9_50.w);
}
#else
{
l9_53=l9_50;
...
{
vec4 l9_56=l9_53;
l9_56.x=l9_53.x+(sc_UniformConstants.x*float(sc_ShaderCacheConstant));
l9_55=l9_56;
}
#else
{
...
{
float l9_57=dot(l9_55,sc_StereoClipPlanes[sc_StereoViewID]);
#if (sc_StereoRendering_IsClipDistanceEnabled==1)
{
sc_SetClipDistancePlatform(l9_57);
}
#else
{
varClipDistance=l9_57;
}
#endif
}
#endif
...
{
l9_23=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_21,sc_ScreenTextureLayout,l9_22),0.0);
}
#else
{
l9_23=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_21,sc_ScreenTextureLayout,l9_22).xy,0.0);
}
#endif
l9_17=l9_23;
}
...
#endif
vec3 l9_26=mix(l9_24.xyz,definedBlend(l9_24.xyz,l9_1.xyz).xyz,vec3(l9_0));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_28=vec4(mix(vec3(1.0),l9_1.xyz,vec3(l9_0)),l9_0);
}
#else
{
vec4 l9_29;
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_37-0.0039215689)),min(1.0,l9_37+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
sc_writeFragData0Internal(vec4(packValue(l9_39),packValue(l9_39),packValue(l9_39),packValue(l9_39)),sc_UniformConstants.x,sc_ShaderCacheConstant);
