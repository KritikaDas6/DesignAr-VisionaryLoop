...
#endif
vec3 l9_32=mix(l9_30.xyz,definedBlend(l9_30.xyz,l9_7.xyz).xyz,vec3(alpha));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_34=vec4(mix(vec3(1.0),l9_7.xyz,vec3(alpha)),alpha);
}
#else
{
vec4 l9_35;
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_43-0.0039215689)),min(1.0,l9_43+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
sc_writeFragData0Internal(vec4(packValue(l9_45),packValue(l9_45),packValue(l9_45),packValue(l9_45)),sc_UniformConstants.x,sc_ShaderCacheConstant);
...
sc_writeFragData0Internal(l9_42,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
