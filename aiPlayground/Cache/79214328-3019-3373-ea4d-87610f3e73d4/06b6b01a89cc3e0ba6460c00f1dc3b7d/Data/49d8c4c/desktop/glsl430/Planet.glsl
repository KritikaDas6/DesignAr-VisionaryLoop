...
#endif
sc_writeFragData0Internal(max(l9_63,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_65;
...
{
l9_86=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_84,sc_ScreenTextureLayout,l9_85),0.0);
}
#else
{
l9_86=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_84,sc_ScreenTextureLayout,l9_85).xy,0.0);
}
#endif
l9_80=l9_86;
}
